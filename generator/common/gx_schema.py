...
# Generation date: 2024-03-20T12:39:12
# Schema: gaia-x
#
...
QUDT_SCHEMA = CurieNamespace("qudt-schema", "http://qudt.org/schema/qudt/")
...
class Address(YAMLRoot):
    ...
    gps: Optional[
        Union[Union[dict, "GPSLocation"], List[Union[dict, "GPSLocation"]]]
    ] = empty_list()
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self._normalize_inlined_as_dict(
            slot_name="gps", slot_type=GPSLocation, key_name="latitude", keyed=False
        )
...
class Device(YAMLRoot):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.defaultOversubscriptionRatio is not None and not isinstance(
            self.defaultOversubscriptionRatio, int
        ):
...
class CPU(Device):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.lastLevelCacheSize is not None and not isinstance(
            self.lastLevelCacheSize, MemorySize
        ):
...
class Endpoint(YAMLRoot):
    ...
    standardConformity: Union[
        Union[dict, "StandardConformity"], List[Union[dict, "StandardConformity"]]
    ] = None
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self._normalize_inlined_as_dict(
            slot_name="standardConformity",
            slot_type=StandardConformity,
            key_name="title",
            keyed=False,
        )
...
class GPU(Device):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.gpuInterconnection is not None and not isinstance(
            self.gpuInterconnection, GPUInterconnetionTypes
        ):
...
class MaintenanceSubscription(YAMLRoot):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        if self.subscriptionIncluded is not None and not isinstance(
            self.subscriptionIncluded, Bool
        ):
            self.subscriptionIncluded = Bool(self.subscriptionIncluded)

        if self.subscriptionRequired is not None and not isinstance(
            self.subscriptionRequired, Bool
        ):
...
class UpdateStrategy(YAMLRoot):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        if self.replaceFrequency is not None and not isinstance(
            self.replaceFrequency, UpdateFrequency
        ):
        ...
        if self.oldVersionsValidUntil is not None and not isinstance(
...
class LegalPerson(Participant):
    ...
    registrationNumber: Union[
        Union[str, LegalPersonRegistrationNumber],
        List[Union[str, LegalPersonRegistrationNumber]],
    ] = None
    legalAddress: Union[dict, Address] = None
    headquartersAddress: Union[dict, Address] = None
    parentOrganizationOf: Optional[
        Union[
            Union[str, LegalPersonRegistrationNumber],
            List[Union[str, LegalPersonRegistrationNumber]],
        ]
    ] = empty_list()
    subOrganisationOf: Optional[
        Union[
            Union[str, LegalPersonRegistrationNumber],
            List[Union[str, LegalPersonRegistrationNumber]],
        ]
...
class PhysicalResource(Resource):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self._normalize_inlined_as_dict(
            slot_name="location", slot_type=Address, key_name="countryCode", keyed=False
        )
...
class Image(CodeArtifact):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.operatingSystem is not None and not isinstance(
        ...
        if self.maintenance is not None and not isinstance(
            self.maintenance, MaintenanceSubscription
        ):
...
class PXEImage(Image):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        if self.pxeImageDiskFormat is not None and not isinstance(
            self.pxeImageDiskFormat, PXEDiskType
        ):
...
class ServiceOffering(GaiaXEntity):
    ...
    serviceOfferingTermsAndConditions: Union[
        Union[dict, "TermsAndConditions"], List[Union[dict, "TermsAndConditions"]]
    ] = None
    ...
    aggregationOfResources: Optional[Union[str, List[str]]] = empty_list()
    dataProtectionRegime: Optional[
        Union[
            Union[str, "PersonalDataProtectionRegime"],
            List[Union[str, "PersonalDataProtectionRegime"]],
        ]
    ] = empty_list()
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self._normalize_inlined_as_dict(
            slot_name="serviceOfferingTermsAndConditions",
            slot_type=TermsAndConditions,
            key_name="url",
            keyed=False,
        )
        ...
        self._normalize_inlined_as_dict(
            slot_name="dataAccountExport",
            slot_type=DataAccountExport,
            key_name="requestType",
            keyed=False,
        )
...
class ComputeServiceOffering(InfrastructureServiceOffering):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        if self.tenantSeparation is not None and not isinstance(
            self.tenantSeparation, TenantSeparation
        ):
...
class VirtualMachineServiceOffering(ComputeServiceOffering):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self._normalize_inlined_as_dict(
            slot_name="codeArtifact",
            slot_type=VMImage,
            key_name="copyrightOwnedBy",
            keyed=False,
        )
        ...
        self._normalize_inlined_as_dict(
            slot_name="instantiationReq",
            slot_type=ServerFlavor,
            key_name="cpu",
            keyed=False,
        )
...
class ContainerServiceOffering(ComputeServiceOffering):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self._normalize_inlined_as_dict(
            slot_name="instantiationReq",
            slot_type=ContainerResourceLimits,
            key_name="confidential",
            keyed=False,
        )
...
class DataResource(VirtualResource):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.expirationDateTime is not None and not isinstance(
            self.expirationDateTime, XSDDateTime
        ):
        ...
        self._normalize_inlined_as_dict(
            slot_name="consent", slot_type=Consent, key_name="legalBasis", keyed=False
        )
...
class Consent(YAMLRoot):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if not isinstance(self.dataProtectionContactPoint, list):
            self.dataProtectionContactPoint = (
                [self.dataProtectionContactPoint]
                if self.dataProtectionContactPoint is not None
                else []
            )
        self.dataProtectionContactPoint = [
            v if isinstance(v, str) else str(v) for v in self.dataProtectionContactPoint
        ]
        ...
        if not isinstance(self.consentWithdrawalContactPoint, list):
            self.consentWithdrawalContactPoint = (
                [self.consentWithdrawalContactPoint]
                if self.consentWithdrawalContactPoint is not None
                else []
            )
        self.consentWithdrawalContactPoint = [
...
class Datacenter(PhysicalResource):
    ...
    aggregationOfResources: Union[
        Union[dict, AvailabilityZone], List[Union[dict, AvailabilityZone]]
    ] = None
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self.aggregationOfResources = [
            ...
            for v in self.aggregationOfResources
        ]
...
class Region(Resource):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        if self._is_empty(self.aggregationOfResources):
            self.MissingRequiredField("aggregationOfResources")
        self._normalize_inlined_as_dict(
            slot_name="aggregationOfResources",
            slot_type=Datacenter,
            key_name="maintainedBy",
            keyed=False,
        )
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if not isinstance(self.containerImageTag, list):
            self.containerImageTag = (
                [self.containerImageTag] if self.containerImageTag is not None else []
            )
        self.containerImageTag = [
            v if isinstance(v, str) else str(v) for v in self.containerImageTag
        ]
...
class ContainerResourceLimits(InstantiationRequirement):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.confidentialComputingTechnology is not None and not isinstance(
            self.confidentialComputingTechnology, ConfidentialComputing
        ):
            self.confidentialComputingTechnology = ConfidentialComputing(
                **as_dict(self.confidentialComputingTechnology)
            )
...
class BackupPolicy(DataProtectionPolicy):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self._normalize_inlined_as_dict(
            slot_name="backupReplication",
            slot_type=ReplicationPolicy,
            key_name="protectionFrequency",
            keyed=False,
        )
...
class SnapshotPolicy(DataProtectionPolicy):
    ...
    protectionFrequency: Union[str, "ProtectionFrequency"] = None
    protectionRetention: Union[dict, RetentionDuration] = None
    snapshotReplication: Optional[
        Union[Union[dict, "ReplicationPolicy"], List[Union[dict, "ReplicationPolicy"]]]
    ] = empty_list()

    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        self._normalize_inlined_as_dict(
            slot_name="snapshotReplication",
            slot_type=ReplicationPolicy,
            key_name="protectionFrequency",
            keyed=False,
        )
...
class ReplicationPolicy(DataProtectionPolicy):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        if self.synchronousReplication is not None and not isinstance(
            self.synchronousReplication, Bool
        ):
            self.synchronousReplication = Bool(self.synchronousReplication)

        if self.consistencyType is not None and not isinstance(
...
@dataclass
class StorageQoS(YAMLRoot):
    """
    Model QoS attributes for storage services
    """

    _inherited_slots: ClassVar[List[str]] = []

    class_class_uri: ClassVar[URIRef] = GX["StorageQoS"]
    class_class_curie: ClassVar[str] = "gx:StorageQoS"
    class_name: ClassVar[str] = "StorageQoS"
    class_model_uri: ClassVar[URIRef] = GX.StorageQoS

    storageThroughput: Optional[Union[dict, QoSMetric]] = None
    storageLatency: Optional[Union[dict, QoSMetric]] = None
    storageIOPS: Optional[Union[dict, QoSMetric]] = None
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.storageIOPS is not None and not isinstance(self.storageIOPS, QoSMetric):
            self.storageIOPS = QoSMetric(**as_dict(self.storageIOPS))
...
class StorageConfiguration(InstantiationRequirement):
    ...
    storageRedundancyMechanism: Optional[
        Union[
            Union[str, "StorageRedundancyMechanism"],
            List[Union[str, "StorageRedundancyMechanism"]],
        ]
    ] = empty_list()
    ...
    blockSize: Optional[
        Union[Union[dict, MemorySize], List[Union[dict, MemorySize]]]
    ] = empty_list()
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self._normalize_inlined_as_dict(
            slot_name="storageEncryption",
            slot_type=Encryption,
            key_name="cipher",
            keyed=False,
        )

        if not isinstance(self.storageCompression, list):
            self.storageCompression = (
                [self.storageCompression] if self.storageCompression is not None else []
            )
        self.storageCompression = [
            v if isinstance(v, CompressionAlgorithm) else CompressionAlgorithm(v)
            for v in self.storageCompression
        ]
        ...
        self._normalize_inlined_as_dict(
            slot_name="storageProtection",
            slot_type=DataProtectionPolicy,
            key_name="protectionFrequency",
            keyed=False,
        )
        ...
        self._normalize_inlined_as_dict(
            slot_name="blockSize", slot_type=MemorySize, key_name="value", keyed=False
        )
...
class FileStorageConfiguration(StorageConfiguration):
    ...
    highLevelAccessProtocol: Optional[
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self.highLevelAccessProtocol = [
            ...
            for v in self.highLevelAccessProtocol
        ]
...
class BlockStorageConfiguration(StorageConfiguration):
    ...
    blockStorageTechnology: Optional[
        Union[
            ...
            List[Union[str, "BlockStorageTechnology"]],
        ]
    ] = empty_list()
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self.blockStorageTechnology = [
            ...
            for v in self.blockStorageTechnology
        ]

        if not isinstance(self.lowLevelBlockAccessProtocol, list):
            self.lowLevelBlockAccessProtocol = (
                [self.lowLevelBlockAccessProtocol]
                if self.lowLevelBlockAccessProtocol is not None
                else []
            )
        self.lowLevelBlockAccessProtocol = [
            v if isinstance(v, BlockAccessProtocol) else BlockAccessProtocol(v)
            for v in self.lowLevelBlockAccessProtocol
        ]
...
class StorageServiceOffering(InfrastructureServiceOffering):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.storageConsistency is not None and not isinstance(
            self.storageConsistency, ConsistencyType
        ):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if not isinstance(self.accessAttributes, list):
            self.accessAttributes = (
                [self.accessAttributes] if self.accessAttributes is not None else []
            )
        self.accessAttributes = [
            v if isinstance(v, AccessAttribute) else AccessAttribute(v)
            for v in self.accessAttributes
        ]
...
class BlockStorageServiceOffering(StorageServiceOffering):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if not isinstance(self.storageConfiguration, BlockStorageConfiguration):
            self.storageConfiguration = BlockStorageConfiguration(
                **as_dict(self.storageConfiguration)
            )
...
class ObjectStorageServiceOffering(StorageServiceOffering):
    ...
    objectAPICompatibility: Optional[
        Union[Union[str, "StorageAPI"], List[Union[str, "StorageAPI"]]]
    ] = empty_list()
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.maximumObjectSize is not None and not isinstance(
            self.maximumObjectSize, MemorySize
        ):
...
class VMImage(Image):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        if self.vmImageDiskFormat is not None and not isinstance(
            self.vmImageDiskFormat, VMDiskType
        ):
...
class ConfidentialComputing(YAMLRoot):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.attestationServiceURI is not None and not isinstance(
            self.attestationServiceURI, URI
        ):
...
class CountryNameAlpha2(EnumDefinitionImpl):
    ...
    AS = PermissibleValue(text="AS", description="Alpha2 code for American Samoa.")
    AD = PermissibleValue(text="AD", description="Alpha2 code for Andorra.")
    AO = PermissibleValue(text="AO", description="Alpha2 code for Angola.")
    AI = PermissibleValue(text="AI", description="Alpha2 code for Anguilla.")
    ...
    AZ = PermissibleValue(text="AZ", description="Alpha2 code for Azerbaijan.")
    ET = PermissibleValue(text="ET", description="Alpha2 code for Ethiopia.")
    AU = PermissibleValue(text="AU", description="Alpha2 code for Australia.")
    BS = PermissibleValue(text="BS", description="Alpha2 code for Bahamas (the).")
    BH = PermissibleValue(text="BH", description="Alpha2 code for Bahrain.")
    BD = PermissibleValue(text="BD", description="Alpha2 code for Bangladesh.")
    BB = PermissibleValue(text="BB", description="Alpha2 code for Barbados.")
    BE = PermissibleValue(text="BE", description="Alpha2 code for Belgium.")
    BZ = PermissibleValue(text="BZ", description="Alpha2 code for Belize.")
    BJ = PermissibleValue(text="BJ", description="Alpha2 code for Benin.")
    BM = PermissibleValue(text="BM", description="Alpha2 code for Bermuda.")
    BT = PermissibleValue(text="BT", description="Alpha2 code for Bhutan.")
    VE = PermissibleValue(
        text="VE", description="Alpha2 code for Venezuela (Bolivarian Republic of)."
    )
    BQ = PermissibleValue(
    ...
    BN = PermissibleValue(text="BN", description="Alpha2 code for Brunei Darussalam.")
    BG = PermissibleValue(text="BG", description="Alpha2 code for Bulgaria.")
    BF = PermissibleValue(text="BF", description="Alpha2 code for Burkina Faso.")
    BI = PermissibleValue(text="BI", description="Alpha2 code for Burundi.")
    CV = PermissibleValue(text="CV", description="Alpha2 code for Cabo Verde.")
    CL = PermissibleValue(text="CL", description="Alpha2 code for Chile.")
    CN = PermissibleValue(text="CN", description="Alpha2 code for China.")
    CK = PermissibleValue(text="CK", description="Alpha2 code for Cook Islands (the).")
    CR = PermissibleValue(text="CR", description="Alpha2 code for Costa Rica.")
    CI = PermissibleValue(text="CI", description="Alpha2 code for Cote dIvoire.")
    CW = PermissibleValue(text="CW", description="Alpha2 code for Curacao.")
    DK = PermissibleValue(text="DK", description="Alpha2 code for Denmark.")
    CD = PermissibleValue(
        text="CD", description="Alpha2 code for Congo (the Democratic Republic of the)."
    )
    KP = PermissibleValue(
        text="KP",
    ...
    LA = PermissibleValue(
        text="LA", description="Alpha2 code for Lao Peoples Democratic Republic (the)."
    )
    ...
    FK = PermissibleValue(
        text="FK", description="Alpha2 code for Falkland Islands (the) [Malvinas]."
    )
    FO = PermissibleValue(text="FO", description="Alpha2 code for Faroe Islands (the).")
    FJ = PermissibleValue(text="FJ", description="Alpha2 code for Fiji.")
    FI = PermissibleValue(text="FI", description="Alpha2 code for Finland.")
    FM = PermissibleValue(
        text="FM", description="Alpha2 code for Micronesia (Federated States of)."
    )
    FR = PermissibleValue(text="FR", description="Alpha2 code for France.")
    TF = PermissibleValue(
        text="TF", description="Alpha2 code for French Southern Territories (the)."
    )
    GF = PermissibleValue(text="GF", description="Alpha2 code for French Guiana.")
    PF = PermissibleValue(text="PF", description="Alpha2 code for French Polynesia.")
    GA = PermissibleValue(text="GA", description="Alpha2 code for Gabon.")
    GM = PermissibleValue(text="GM", description="Alpha2 code for Gambia (the).")
    GE = PermissibleValue(text="GE", description="Alpha2 code for Georgia.")
    GH = PermissibleValue(text="GH", description="Alpha2 code for Ghana.")
    GI = PermissibleValue(text="GI", description="Alpha2 code for Gibraltar.")
    GD = PermissibleValue(text="GD", description="Alpha2 code for Grenada.")
    GR = PermissibleValue(text="GR", description="Alpha2 code for Greece.")
    GL = PermissibleValue(text="GL", description="Alpha2 code for Greenland.")
    GP = PermissibleValue(text="GP", description="Alpha2 code for Guadeloupe.")
    GU = PermissibleValue(text="GU", description="Alpha2 code for Guam.")
    GT = PermissibleValue(text="GT", description="Alpha2 code for Guatemala.")
    GG = PermissibleValue(text="GG", description="Alpha2 code for Guernsey.")
    GN = PermissibleValue(text="GN", description="Alpha2 code for Guinea.")
    GW = PermissibleValue(text="GW", description="Alpha2 code for Guinea-Bissau.")
    GY = PermissibleValue(text="GY", description="Alpha2 code for Guyana.")
    HT = PermissibleValue(text="HT", description="Alpha2 code for Haiti.")
    HM = PermissibleValue(
        text="HM", description="Alpha2 code for Heard Island and McDonald Islands."
    )
    HN = PermissibleValue(text="HN", description="Alpha2 code for Honduras.")
    HK = PermissibleValue(text="HK", description="Alpha2 code for Hong Kong.")
    IN = PermissibleValue(text="IN", description="Alpha2 code for India.")
    ID = PermissibleValue(text="ID", description="Alpha2 code for Indonesia.")
    ...
    JM = PermissibleValue(text="JM", description="Alpha2 code for Jamaica.")
    JP = PermissibleValue(text="JP", description="Alpha2 code for Japan.")
    ...
    KZ = PermissibleValue(text="KZ", description="Alpha2 code for Kazakhstan.")
    QA = PermissibleValue(text="QA", description="Alpha2 code for Qatar.")
    ...
    HR = PermissibleValue(text="HR", description="Alpha2 code for Croatia.")
    CU = PermissibleValue(text="CU", description="Alpha2 code for Cuba.")
    KW = PermissibleValue(text="KW", description="Alpha2 code for Kuwait.")
    LS = PermissibleValue(text="LS", description="Alpha2 code for Lesotho.")
    LV = PermissibleValue(text="LV", description="Alpha2 code for Latvia.")
    LB = PermissibleValue(text="LB", description="Alpha2 code for Lebanon.")
    LR = PermissibleValue(text="LR", description="Alpha2 code for Liberia.")
    LY = PermissibleValue(text="LY", description="Alpha2 code for Libya.")
    LI = PermissibleValue(text="LI", description="Alpha2 code for Liechtenstein.")
    LT = PermissibleValue(text="LT", description="Alpha2 code for Lithuania.")
    LU = PermissibleValue(text="LU", description="Alpha2 code for Luxembourg.")
    MO = PermissibleValue(text="MO", description="Alpha2 code for Macao.")
    MG = PermissibleValue(text="MG", description="Alpha2 code for Madagascar.")
    MW = PermissibleValue(text="MW", description="Alpha2 code for Malawi.")
    MY = PermissibleValue(text="MY", description="Alpha2 code for Malaysia.")
    ...
    YT = PermissibleValue(text="YT", description="Alpha2 code for Mayotte.")
    MX = PermissibleValue(text="MX", description="Alpha2 code for Mexico.")
    MC = PermissibleValue(text="MC", description="Alpha2 code for Monaco.")
    MN = PermissibleValue(text="MN", description="Alpha2 code for Mongolia.")
    MS = PermissibleValue(text="MS", description="Alpha2 code for Montserrat.")
    ME = PermissibleValue(text="ME", description="Alpha2 code for Montenegro.")
    MZ = PermissibleValue(text="MZ", description="Alpha2 code for Mozambique.")
    MM = PermissibleValue(text="MM", description="Alpha2 code for Myanmar.")
    NA = PermissibleValue(text="NA", description="Alpha2 code for Namibia.")
    NR = PermissibleValue(text="NR", description="Alpha2 code for Nauru.")
    NP = PermissibleValue(text="NP", description="Alpha2 code for Nepal.")
    NC = PermissibleValue(text="NC", description="Alpha2 code for New Caledonia.")
    NZ = PermissibleValue(text="NZ", description="Alpha2 code for New Zealand.")
    NI = PermissibleValue(text="NI", description="Alpha2 code for Nicaragua.")
    NL = PermissibleValue(text="NL", description="Alpha2 code for Netherlands (the).")
    NE = PermissibleValue(text="NE", description="Alpha2 code for Niger (the).")
    NG = PermissibleValue(text="NG", description="Alpha2 code for Nigeria.")
    NU = PermissibleValue(text="NU", description="Alpha2 code for Niue.")
    NF = PermissibleValue(text="NF", description="Alpha2 code for Norfolk Island.")
    OM = PermissibleValue(text="OM", description="Alpha2 code for Oman.")
    AT = PermissibleValue(text="AT", description="Alpha2 code for Austria.")
    PK = PermissibleValue(text="PK", description="Alpha2 code for Pakistan.")
    PW = PermissibleValue(text="PW", description="Alpha2 code for Palau.")
    PS = PermissibleValue(text="PS", description="Alpha2 code for Palestine, State of.")
    PA = PermissibleValue(text="PA", description="Alpha2 code for Panama.")
    PG = PermissibleValue(text="PG", description="Alpha2 code for Papua New Guinea.")
    PY = PermissibleValue(text="PY", description="Alpha2 code for Paraguay.")
    PE = PermissibleValue(text="PE", description="Alpha2 code for Peru.")
    PH = PermissibleValue(text="PH", description="Alpha2 code for Philippines (the).")
    PN = PermissibleValue(text="PN", description="Alpha2 code for Pitcairn.")
    BO = PermissibleValue(
        text="BO", description="Alpha2 code for Bolivia (Plurinational State of)."
    )
    ...
    SN = PermissibleValue(text="SN", description="Alpha2 code for Senegal.")
    RS = PermissibleValue(text="RS", description="Alpha2 code for Serbia.")
    SC = PermissibleValue(text="SC", description="Alpha2 code for Seychelles.")
    SL = PermissibleValue(text="SL", description="Alpha2 code for Sierra Leone.")
    ZW = PermissibleValue(text="ZW", description="Alpha2 code for Zimbabwe.")
    SG = PermissibleValue(text="SG", description="Alpha2 code for Singapore.")
    SK = PermissibleValue(text="SK", description="Alpha2 code for Slovakia.")
    SI = PermissibleValue(text="SI", description="Alpha2 code for Slovenia.")
    SO = PermissibleValue(text="SO", description="Alpha2 code for Somalia.")
    ES = PermissibleValue(text="ES", description="Alpha2 code for Spain.")
    LK = PermissibleValue(text="LK", description="Alpha2 code for Sri Lanka.")
    BL = PermissibleValue(text="BL", description="Alpha2 code for Saint Barthelemy.")
    SH = PermissibleValue(
        text="SH",
    ...
    ZA = PermissibleValue(text="ZA", description="Alpha2 code for South Africa.")
    SD = PermissibleValue(text="SD", description="Alpha2 code for Sudan (the).")
    GS = PermissibleValue(
        text="GS",
    ...
    TK = PermissibleValue(text="TK", description="Alpha2 code for Tokelau.")
    TO = PermissibleValue(text="TO", description="Alpha2 code for Tonga.")
    TT = PermissibleValue(text="TT", description="Alpha2 code for Trinidad and Tobago.")
    TD = PermissibleValue(text="TD", description="Alpha2 code for Chad.")
    CZ = PermissibleValue(text="CZ", description="Alpha2 code for Czechia.")
    ...
    HU = PermissibleValue(text="HU", description="Alpha2 code for Hungary.")
    UY = PermissibleValue(text="UY", description="Alpha2 code for Uruguay.")
    ...
    VN = PermissibleValue(text="VN", description="Alpha2 code for Viet Nam.")
    WF = PermissibleValue(text="WF", description="Alpha2 code for Wallis and Futuna.")
    ...
    def _addvals(cls):
        setattr(
            cls,
            "False",
            PermissibleValue(text="False", description="Alpha2 code for Norway."),
        )
...
class CountryNameAlpha3(EnumDefinitionImpl):
    ...
    DZA = PermissibleValue(text="DZA", description="Alpha3 code for Algeria.")
    ASM = PermissibleValue(text="ASM", description="Alpha3 code for American Samoa.")
    AND = PermissibleValue(text="AND", description="Alpha3 code for Andorra.")
    ...
    AUS = PermissibleValue(text="AUS", description="Alpha3 code for Australia.")
    AUT = PermissibleValue(text="AUT", description="Alpha3 code for Austria.")
    AZE = PermissibleValue(text="AZE", description="Alpha3 code for Azerbaijan.")
    BHS = PermissibleValue(text="BHS", description="Alpha3 code for Bahamas (the).")
    BHR = PermissibleValue(text="BHR", description="Alpha3 code for Bahrain.")
    BGD = PermissibleValue(text="BGD", description="Alpha3 code for Bangladesh.")
    BRB = PermissibleValue(text="BRB", description="Alpha3 code for Barbados.")
    BLR = PermissibleValue(text="BLR", description="Alpha3 code for Belarus.")
    BEL = PermissibleValue(text="BEL", description="Alpha3 code for Belgium.")
    BLZ = PermissibleValue(text="BLZ", description="Alpha3 code for Belize.")
    BEN = PermissibleValue(text="BEN", description="Alpha3 code for Benin.")
    BMU = PermissibleValue(text="BMU", description="Alpha3 code for Bermuda.")
    BTN = PermissibleValue(text="BTN", description="Alpha3 code for Bhutan.")
    BOL = PermissibleValue(
        text="BOL", description="Alpha3 code for Bolivia (Plurinational State of)."
    )
    ...
    IOT = PermissibleValue(
        text="IOT", description="Alpha3 code for British Indian Ocean Territory (the)."
    )
    BRN = PermissibleValue(text="BRN", description="Alpha3 code for Brunei Darussalam.")
    BGR = PermissibleValue(text="BGR", description="Alpha3 code for Bulgaria.")
    BFA = PermissibleValue(text="BFA", description="Alpha3 code for Burkina Faso.")
    BDI = PermissibleValue(text="BDI", description="Alpha3 code for Burundi.")
    KHM = PermissibleValue(text="KHM", description="Alpha3 code for Cambodia.")
    ...
    TCD = PermissibleValue(text="TCD", description="Alpha3 code for Chad.")
    ...
    CUB = PermissibleValue(text="CUB", description="Alpha3 code for Cuba.")
    CUW = PermissibleValue(text="CUW", description="Alpha3 code for Curacao.")
    CYP = PermissibleValue(text="CYP", description="Alpha3 code for Cyprus.")
    CZE = PermissibleValue(text="CZE", description="Alpha3 code for Czechia.")
    ...
    GNQ = PermissibleValue(text="GNQ", description="Alpha3 code for Equatorial Guinea.")
    ERI = PermissibleValue(text="ERI", description="Alpha3 code for Eritrea.")
    EST = PermissibleValue(text="EST", description="Alpha3 code for Estonia.")
    ETH = PermissibleValue(text="ETH", description="Alpha3 code for Ethiopia.")
    ...
    GUF = PermissibleValue(text="GUF", description="Alpha3 code for French Guiana.")
    PYF = PermissibleValue(text="PYF", description="Alpha3 code for French Polynesia.")
    ATF = PermissibleValue(
        text="ATF", description="Alpha3 code for French Southern Territories (the)."
    )
    GAB = PermissibleValue(text="GAB", description="Alpha3 code for Gabon.")
    GMB = PermissibleValue(text="GMB", description="Alpha3 code for Gambia (the).")
    GEO = PermissibleValue(text="GEO", description="Alpha3 code for Georgia.")
    DEU = PermissibleValue(text="DEU", description="Alpha3 code for Germany.")
    GHA = PermissibleValue(text="GHA", description="Alpha3 code for Ghana.")
    GIB = PermissibleValue(text="GIB", description="Alpha3 code for Gibraltar.")
    GRC = PermissibleValue(text="GRC", description="Alpha3 code for Greece.")
    GRL = PermissibleValue(text="GRL", description="Alpha3 code for Greenland.")
    GRD = PermissibleValue(text="GRD", description="Alpha3 code for Grenada.")
    GLP = PermissibleValue(text="GLP", description="Alpha3 code for Guadeloupe.")
    GUM = PermissibleValue(text="GUM", description="Alpha3 code for Guam.")
    GTM = PermissibleValue(text="GTM", description="Alpha3 code for Guatemala.")
    GGY = PermissibleValue(text="GGY", description="Alpha3 code for Guernsey.")
    GIN = PermissibleValue(text="GIN", description="Alpha3 code for Guinea.")
    GNB = PermissibleValue(text="GNB", description="Alpha3 code for Guinea-Bissau.")
    GUY = PermissibleValue(text="GUY", description="Alpha3 code for Guyana.")
    HTI = PermissibleValue(text="HTI", description="Alpha3 code for Haiti.")
    HMD = PermissibleValue(
        text="HMD", description="Alpha3 code for Heard Island and McDonald Islands."
    )
    VAT = PermissibleValue(text="VAT", description="Alpha3 code for Holy See (the).")
    HND = PermissibleValue(text="HND", description="Alpha3 code for Honduras.")
    HKG = PermissibleValue(text="HKG", description="Alpha3 code for Hong Kong.")
    HUN = PermissibleValue(text="HUN", description="Alpha3 code for Hungary.")
    ...
    ISR = PermissibleValue(text="ISR", description="Alpha3 code for Israel.")
    ITA = PermissibleValue(text="ITA", description="Alpha3 code for Italy.")
    JAM = PermissibleValue(text="JAM", description="Alpha3 code for Jamaica.")
    JPN = PermissibleValue(text="JPN", description="Alpha3 code for Japan.")
    JEY = PermissibleValue(text="JEY", description="Alpha3 code for Jersey.")
    JOR = PermissibleValue(text="JOR", description="Alpha3 code for Jordan.")
    KAZ = PermissibleValue(text="KAZ", description="Alpha3 code for Kazakhstan.")
    KEN = PermissibleValue(text="KEN", description="Alpha3 code for Kenya.")
    KIR = PermissibleValue(text="KIR", description="Alpha3 code for Kiribati.")
    ...
    LAO = PermissibleValue(
        text="LAO", description="Alpha3 code for Lao Peoples Democratic Republic (the)."
    )
    LVA = PermissibleValue(text="LVA", description="Alpha3 code for Latvia.")
    LBN = PermissibleValue(text="LBN", description="Alpha3 code for Lebanon.")
    LSO = PermissibleValue(text="LSO", description="Alpha3 code for Lesotho.")
    LBR = PermissibleValue(text="LBR", description="Alpha3 code for Liberia.")
    LBY = PermissibleValue(text="LBY", description="Alpha3 code for Libya.")
    LIE = PermissibleValue(text="LIE", description="Alpha3 code for Liechtenstein.")
    ...
    MYT = PermissibleValue(text="MYT", description="Alpha3 code for Mayotte.")
    MEX = PermissibleValue(text="MEX", description="Alpha3 code for Mexico.")
    ...
    MSR = PermissibleValue(text="MSR", description="Alpha3 code for Montserrat.")
    MAR = PermissibleValue(text="MAR", description="Alpha3 code for Morocco.")
    MOZ = PermissibleValue(text="MOZ", description="Alpha3 code for Mozambique.")
    MMR = PermissibleValue(text="MMR", description="Alpha3 code for Myanmar.")
    NAM = PermissibleValue(text="NAM", description="Alpha3 code for Namibia.")
    NRU = PermissibleValue(text="NRU", description="Alpha3 code for Nauru.")
    NPL = PermissibleValue(text="NPL", description="Alpha3 code for Nepal.")
    NLD = PermissibleValue(text="NLD", description="Alpha3 code for Netherlands (the).")
    NCL = PermissibleValue(text="NCL", description="Alpha3 code for New Caledonia.")
    NZL = PermissibleValue(text="NZL", description="Alpha3 code for New Zealand.")
    NIC = PermissibleValue(text="NIC", description="Alpha3 code for Nicaragua.")
    NER = PermissibleValue(text="NER", description="Alpha3 code for Niger (the).")
    NGA = PermissibleValue(text="NGA", description="Alpha3 code for Nigeria.")
    NIU = PermissibleValue(text="NIU", description="Alpha3 code for Niue.")
    NFK = PermissibleValue(text="NFK", description="Alpha3 code for Norfolk Island.")
    MNP = PermissibleValue(
        text="MNP", description="Alpha3 code for Northern Mariana Islands (the)."
    )
    NOR = PermissibleValue(text="NOR", description="Alpha3 code for Norway.")
    ...
    PER = PermissibleValue(text="PER", description="Alpha3 code for Peru.")
    PHL = PermissibleValue(text="PHL", description="Alpha3 code for Philippines (the).")
    PCN = PermissibleValue(text="PCN", description="Alpha3 code forPitcairn.")
    POL = PermissibleValue(text="POL", description="Alpha3 code for Poland.")
    PRT = PermissibleValue(text="PRT", description="Alpha3 code for Portugal.")
    PRI = PermissibleValue(text="PRI", description="Alpha3 code for Puerto Rico.")
    QAT = PermissibleValue(text="QAT", description="Alpha3 code for Qatar.")
    ...
    SOM = PermissibleValue(text="SOM", description="Alpha3 code for Somalia.")
    ZAF = PermissibleValue(text="ZAF", description="Alpha3 code for South Africa.")
    SGS = PermissibleValue(
        text="SGS",
        description="Alpha3 code for South Georgia and the South Sandwich Islands.",
    )
    SSD = PermissibleValue(text="SSD", description="Alpha3 code for South Sudan.")
    ESP = PermissibleValue(text="ESP", description="Alpha3 code for Spain.")
    ...
    XTX = PermissibleValue(
        text="XTX", description="Alpha3 code for Turkish Republic of northern Cyprus."
    )
    TKM = PermissibleValue(text="TKM", description="Alpha3 code for Turkmenistan.")
    TCA = PermissibleValue(
        text="TCA", description="Alpha3 code for Turks and Caicos Islands (the)."
    )
    ...
    USA = PermissibleValue(
        text="USA", description="Alpha3 code for United States of America (the)."
    )
    UMI = PermissibleValue(
        text="UMI",
        description="Alpha3 code for United States Minor Outlying Islands (the).",
    )
    URY = PermissibleValue(text="URY", description="Alpha3 code for Uruguay.")
    UZB = PermissibleValue(text="UZB", description="Alpha3 code for Uzbekistan.")
    VUT = PermissibleValue(text="VUT", description="Alpha3 code for Vanuatu.")
    ...
    ZMB = PermissibleValue(text="ZMB", description="Alpha3 code for Zambia.")
    ZWE = PermissibleValue(text="ZWE", description="Alpha3 code for Zimbabwe.")
    XKX = PermissibleValue(text="XKX", description="Alpha3 code for Kosovo.")
...
class CountryNameNumeric(EnumDefinitionImpl):
    ...
    def _addvals(cls):
        setattr(
            cls,
            "4",
            PermissibleValue(text="4", description="Numeric code for Afghanistan."),
        )
        setattr(
            cls,
            "818",
            PermissibleValue(text="818", description="Numeric code for Egypt."),
        )
        setattr(
            cls,
            "248",
            PermissibleValue(text="248", description="Numeric code for Aland Islands."),
        )
        setattr(
            cls,
            "008",
            PermissibleValue(text="008", description="Numeric code for Albania."),
        )
        setattr(
            cls,
            "10",
            PermissibleValue(text="10", description="Numeric code for Algeria."),
        )
        setattr(
            cls,
            "850",
        ...
        setattr(
            cls,
            "14",
            PermissibleValue(text="14", description="Numeric code for American Samoa."),
        )
        setattr(
            cls,
            "16",
            PermissibleValue(text="16", description="Numeric code for Andorra."),
        )
        setattr(
            cls,
            "20",
            PermissibleValue(text="20", description="Numeric code for Angola."),
        )
        setattr(
            cls,
            "660",
            PermissibleValue(text="660", description="Numeric code for Anguilla."),
        )
        setattr(
            cls,
            "8",
            PermissibleValue(text="8", description="Numeric code for Antarctica."),
        )
        setattr(
            cls,
            "028",
        ...
        setattr(
            cls,
            "26",
            PermissibleValue(text="26", description="Numeric code for Argentina."),
        )
        setattr(
            cls,
            "41",
            PermissibleValue(text="41", description="Numeric code for Armenia."),
        )
        setattr(
            cls,
            "231",
            PermissibleValue(text="231", description="Numeric code for Ethiopia."),
        )
        setattr(
            cls,
            "30",
            PermissibleValue(text="30", description="Numeric code for Australia."),
        )
        setattr(
            cls,
            "36",
            PermissibleValue(text="36", description="Numeric code for Bahamas (the)."),
        )
        setattr(
            cls,
            "048",
            PermissibleValue(text="048", description="Numeric code for Bahrain."),
        )
        setattr(
            cls,
            "40",
            PermissibleValue(text="40", description="Numeric code for Bangladesh."),
        )
        setattr(
            cls,
            "42",
            PermissibleValue(text="42", description="Numeric code for Barbados."),
        )
        setattr(
            cls,
            "46",
            PermissibleValue(text="46", description="Numeric code forBelgium."),
        )
        setattr(
            cls,
            "084",
            PermissibleValue(text="084", description="Numeric code for Belize."),
        )
        setattr(
            cls,
            "204",
            PermissibleValue(text="204", description="Numeric code for Benin."),
        )
        setattr(
            cls,
            "48",
            PermissibleValue(text="48", description="Numeric code for Bermuda."),
        )
        setattr(
            cls,
            "52",
            PermissibleValue(text="52", description="Numeric code for Bhutan."),
        )
        setattr(
            cls,
            "58",
            PermissibleValue(text="58", description="Numeric code for Botswana."),
        )
        setattr(
            cls,
            "60",
            PermissibleValue(text="60", description="Numeric code for Bouvet Island."),
        )
        setattr(
            cls,
            "62",
            PermissibleValue(text="62", description="Numeric code for Brazil."),
        )
        setattr(
            cls,
            "092",
        ...
        setattr(
            cls,
            "854",
            PermissibleValue(text="854", description="Numeric code for Burkina Faso."),
        )
        setattr(
            cls,
            "108",
            PermissibleValue(text="108", description="Numeric code for Burundi."),
        )
        setattr(
            cls,
            "132",
            PermissibleValue(text="132", description="Numeric code for Cabo Verde."),
        )
        setattr(
            cls,
            "152",
            PermissibleValue(text="152", description="Numeric code for Chile."),
        )
        setattr(
            cls,
            "156",
            PermissibleValue(text="156", description="Numeric code for China."),
        )
        setattr(
            cls,
            "184",
        ...
        setattr(
            cls,
            "188",
            PermissibleValue(text="188", description="Numeric code for Costa Rica."),
        )
        setattr(
            cls,
            "384",
            PermissibleValue(text="384", description="Numeric code for Cote dIvoire."),
        )
        setattr(
            cls,
            "531",
            PermissibleValue(text="531", description="Numeric code for Curacao."),
        )
        setattr(
            cls,
            "208",
            PermissibleValue(text="208", description="Numeric code for Denmark."),
        )
        setattr(
            cls,
            "180",
        ...
        setattr(
            cls,
            "276",
            PermissibleValue(text="276", description="Numeric code for Germany."),
        )
        setattr(
            cls,
            "212",
            PermissibleValue(text="212", description="Numeric code for Dominica."),
        )
        setattr(
            cls,
            "214",
        ...
        setattr(
            cls,
            "262",
            PermissibleValue(text="262", description="Numeric code for Djibouti."),
        )
        setattr(
            cls,
            "218",
            PermissibleValue(text="218", description="Numeric code for Ecuador."),
        )
        setattr(
            cls,
            "807",
            PermissibleValue(
                text="807", description="Numeric code for Republic of North Macedonia."
            ),
        )
        setattr(
            cls,
            "222",
            PermissibleValue(text="222", description="Numeric code for El Salvador."),
        )
        setattr(
            cls,
            "232",
            PermissibleValue(text="232", description="Numeric code for Eritrea."),
        )
        setattr(
            cls,
            "233",
            PermissibleValue(text="233", description="Numeric code for Estonia."),
        )
        setattr(
            cls,
            "238",
        ...
        setattr(
            cls,
            "242",
            PermissibleValue(text="242", description="Numeric code for Fiji."),
        )
        setattr(
            cls,
            "246",
            PermissibleValue(text="246", description="Numeric code for Finland."),
        )
        setattr(
            cls,
            "583",
        ...
        setattr(
            cls,
            "250",
            PermissibleValue(text="250", description="Numeric code for France."),
        )
        setattr(
            cls,
            "260",
        ...
        setattr(
            cls,
            "254",
            PermissibleValue(text="254", description="Numeric code for French Guiana."),
        )
        setattr(
            cls,
            "258",
        ...
        setattr(
            cls,
            "266",
            PermissibleValue(text="266", description="Numeric code for Gabon."),
        )
        setattr(
            cls,
            "270",
            PermissibleValue(text="270", description="Numeric code for Gambia (the)."),
        )
        setattr(
            cls,
            "268",
            PermissibleValue(text="268", description="Numeric code for Georgia."),
        )
        setattr(
            cls,
            "288",
            PermissibleValue(text="288", description="Numeric code for Ghana."),
        )
        setattr(
            cls,
            "292",
            PermissibleValue(text="292", description="Numeric code for Gibraltar."),
        )
        setattr(
            cls,
            "308",
            PermissibleValue(text="308", description="Numeric code for Grenada."),
        )
        setattr(
            cls,
            "300",
            PermissibleValue(text="300", description="Numeric code for Greece."),
        )
        setattr(
            cls,
            "304",
            PermissibleValue(text="304", description="Numeric code for Greenland."),
        )
        setattr(
            cls,
            "312",
            PermissibleValue(text="312", description="Numeric code for Guadeloupe."),
        )
        setattr(
            cls,
            "316",
            PermissibleValue(text="316", description="Numeric code for Guam."),
        )
        setattr(
            cls,
            "320",
            PermissibleValue(text="320", description="Numeric code for Guatemala."),
        )
        setattr(
            cls,
            "831",
            PermissibleValue(text="831", description="Numeric code for Guernsey."),
        )
        setattr(
            cls,
            "324",
            PermissibleValue(text="324", description="Numeric code for Guinea."),
        )
        setattr(
            cls,
            "624",
            PermissibleValue(text="624", description="Numeric code for Guinea-Bissau."),
        )
        setattr(
            cls,
            "328",
            PermissibleValue(text="328", description="Numeric code for Guyana."),
        )
        setattr(
            cls,
            "332",
            PermissibleValue(text="332", description="Numeric code for Haiti."),
        )
        setattr(
            cls,
            "334",
        ...
        setattr(
            cls,
            "340",
            PermissibleValue(text="340", description="Numeric code for Honduras."),
        )
        setattr(
            cls,
            "344",
            PermissibleValue(text="344", description="Numeric code for Hong Kong."),
        )
        setattr(
            cls,
            "356",
            PermissibleValue(text="356", description="Numeric code for India."),
        )
        setattr(
            cls,
            "360",
            PermissibleValue(text="360", description="Numeric code for Indonesia."),
        )
        setattr(
            cls,
            "833",
            PermissibleValue(text="833", description="Numeric code for Isle of Man."),
        )
        setattr(
            cls,
            "368",
            PermissibleValue(text="368", description="Numeric code for Iraq."),
        )
        setattr(
            cls,
            "372",
            PermissibleValue(text="372", description="Numeric code for Ireland."),
        )
        setattr(
            cls,
            "364",
            PermissibleValue(
                text="364", description="Numeric code for Iran (Islamic Republic of)."
            ),
        )
        setattr(
            cls,
            "352",
            PermissibleValue(text="352", description="Numeric code for Iceland."),
        )
        setattr(
            cls,
            "376",
            PermissibleValue(text="376", description="Numeric code for Israel."),
        )
        setattr(
            cls,
            "380",
            PermissibleValue(text="380", description="Numeric code for Italy."),
        )
        setattr(
            cls,
            "388",
            PermissibleValue(text="388", description="Numeric code for Jamaica."),
        )
        setattr(
            cls,
            "392",
            PermissibleValue(text="392", description="Numeric code for Japan."),
        )
        setattr(
            cls,
            "887",
            PermissibleValue(text="887", description="Numeric code for Yemen."),
        )
        setattr(
            cls,
            "832",
            PermissibleValue(text="832", description="Numeric code for Jersey."),
        )
        setattr(
            cls,
            "400",
            PermissibleValue(text="400", description="Numeric code for Jordan."),
        )
        setattr(
            cls,
            "136",
        ...
        setattr(
            cls,
            "116",
            PermissibleValue(text="116", description="Numeric code for Cambodia."),
        )
        setattr(
            cls,
            "120",
            PermissibleValue(text="120", description="Numeric code for Cameroon."),
        )
        setattr(
            cls,
            "124",
            PermissibleValue(text="124", description="Numeric code for Canada."),
        )
        setattr(
            cls,
            "398",
            PermissibleValue(text="398", description="Numeric code for Kazakhstan."),
        )
        setattr(
            cls,
            "634",
            PermissibleValue(text="634", description="Numeric code for Qatar."),
        )
        setattr(
            cls,
            "404",
            PermissibleValue(text="404", description="Numeric code for Kenya."),
        )
        setattr(
            cls,
            "417",
            PermissibleValue(text="417", description="Numeric code for Kyrgyzstan."),
        )
        setattr(
            cls,
            "296",
            PermissibleValue(text="296", description="Numeric code for Kiribati."),
        )
        setattr(
            cls,
            "166",
        ...
        setattr(
            cls,
            "170",
            PermissibleValue(text="170", description="Numeric code for Colombia."),
        )
        setattr(
            cls,
            "174",
            PermissibleValue(text="174", description="Numeric code for Comoros (the)."),
        )
        setattr(
            cls,
            "178",
            PermissibleValue(text="178", description="Numeric code for Congo (the)."),
        )
        setattr(
            cls,
            "191",
            PermissibleValue(text="191", description="Numeric code for Croatia."),
        )
        setattr(
            cls,
            "192",
            PermissibleValue(text="192", description="Numeric code for Cuba."),
        )
        setattr(
            cls,
            "414",
            PermissibleValue(text="414", description="Numeric code for Kuwait."),
        )
        setattr(
            cls,
            "426",
            PermissibleValue(text="426", description="Numeric code for Lesotho."),
        )
        setattr(
            cls,
            "428",
            PermissibleValue(text="428", description="Numeric code for Latvia."),
        )
        setattr(
            cls,
            "422",
            PermissibleValue(text="422", description="Numeric code for Lebanon."),
        )
        setattr(
            cls,
            "430",
            PermissibleValue(text="430", description="Numeric code for Liberia."),
        )
        setattr(
            cls,
            "434",
            PermissibleValue(text="434", description="Numeric code for Libya."),
        )
        setattr(
            cls,
            "438",
            PermissibleValue(text="438", description="Numeric code for Liechtenstein."),
        )
        setattr(
            cls,
            "440",
            PermissibleValue(text="440", description="Numeric code for Lithuania."),
        )
        setattr(
            cls,
            "442",
            PermissibleValue(text="442", description="Numeric code for Luxembourg."),
        )
        setattr(
            cls,
            "446",
            PermissibleValue(text="446", description="Numeric code for Macao."),
        )
        setattr(
            cls,
            "450",
            PermissibleValue(text="450", description="Numeric code for Madagascar."),
        )
        setattr(
            cls,
            "454",
            PermissibleValue(text="454", description="Numeric code for Malawi."),
        )
        setattr(
            cls,
            "458",
            PermissibleValue(text="458", description="Numeric code for Malaysia."),
        )
        setattr(
            cls,
            "462",
            PermissibleValue(text="462", description="Numeric code for Maldives."),
        )
        setattr(
            cls,
            "466",
            PermissibleValue(text="466", description="Numeric code for Mali."),
        )
        setattr(
            cls,
            "470",
            PermissibleValue(text="470", description="Numeric code for Malta    ."),
        )
        setattr(
            cls,
            "580",
        ...
        setattr(
            cls,
            "504",
            PermissibleValue(text="504", description="Numeric code for Morocco."),
        )
        setattr(
            cls,
            "584",
        ...
        setattr(
            cls,
            "474",
            PermissibleValue(text="474", description="Numeric code for Martinique."),
        )
        setattr(
            cls,
            "478",
            PermissibleValue(text="478", description="Numeric code for Mauritania."),
        )
        setattr(
            cls,
            "480",
            PermissibleValue(text="480", description="Numeric code for Mauritius."),
        )
        setattr(
            cls,
            "175",
            PermissibleValue(text="175", description="Numeric code for Mayotte."),
        )
        setattr(
            cls,
            "484",
            PermissibleValue(text="484", description="Numeric code for Mexico."),
        )
        setattr(
            cls,
            "492",
            PermissibleValue(text="492", description="Numeric code for Monaco."),
        )
        setattr(
            cls,
            "496",
            PermissibleValue(text="496", description="Numeric code for Mongolia."),
        )
        setattr(
            cls,
            "500",
            PermissibleValue(text="500", description="Numeric code for Montserrat."),
        )
        setattr(
            cls,
            "499",
            PermissibleValue(text="499", description="Numeric code for Montenegro."),
        )
        setattr(
            cls,
            "508",
            PermissibleValue(text="508", description="Numeric code for Mozambique."),
        )
        setattr(
            cls,
            "104",
            PermissibleValue(text="104", description="Numeric code for Myanmar."),
        )
        setattr(
            cls,
            "516",
            PermissibleValue(text="516", description="Numeric code for Namibia."),
        )
        setattr(
            cls,
            "520",
            PermissibleValue(text="520", description="Numeric code for Nauru."),
        )
        setattr(
            cls,
            "524",
            PermissibleValue(text="524", description="Numeric code for Nepal."),
        )
        setattr(
            cls,
            "540",
            PermissibleValue(text="540", description="Numeric code for New Caledonia."),
        )
        setattr(
            cls,
            "554",
            PermissibleValue(text="554", description="Numeric code for New Zealand."),
        )
        setattr(
            cls,
            "558",
            PermissibleValue(text="558", description="Numeric code for Nicaragua."),
        )
        setattr(
            cls,
            "528",
        ...
        setattr(
            cls,
            "562",
            PermissibleValue(text="562", description="Numeric code for Niger (the)."),
        )
        setattr(
            cls,
            "566",
            PermissibleValue(text="566", description="Numeric code for Nigeria."),
        )
        setattr(
            cls,
            "570",
            PermissibleValue(text="570", description="Numeric code for Niue."),
        )
        setattr(
            cls,
            "574",
        ...
        setattr(
            cls,
            "578",
            PermissibleValue(text="578", description="Numeric code for Norway."),
        )
        setattr(
            cls,
            "512",
            PermissibleValue(text="512", description="Numeric code for Oman."),
        )
        setattr(
            cls,
            "32",
            PermissibleValue(text="32", description="Numeric code for Austria."),
        )
        setattr(
            cls,
            "586",
            PermissibleValue(text="586", description="Numeric code for Pakistan."),
        )
        setattr(
            cls,
            "585",
            PermissibleValue(text="585", description="Numeric code for Palau."),
        )
        setattr(
            cls,
            "275",
        ...
        setattr(
            cls,
            "591",
            PermissibleValue(text="591", description="Numeric code for Panama."),
        )
        setattr(
            cls,
            "598",
        ...
        setattr(
            cls,
            "600",
            PermissibleValue(text="600", description="Numeric code for Paraguay."),
        )
        setattr(
            cls,
            "604",
            PermissibleValue(text="604", description="Numeric code for Peru."),
        )
        setattr(
            cls,
            "608",
        ...
        setattr(
            cls,
            "612",
            PermissibleValue(text="612", description="Numeric code for Pitcairn."),
        )
        setattr(
            cls,
            "068",
        ...
        setattr(
            cls,
            "616",
            PermissibleValue(text="616", description="Numeric code for Poland."),
        )
        setattr(
            cls,
            "620",
            PermissibleValue(text="620", description="Numeric code for Portugal."),
        )
        setattr(
            cls,
            "630",
            PermissibleValue(text="630", description="Numeric code for Puerto Rico."),
        )
        setattr(
            cls,
            "410",
        ...
        setattr(
            cls,
            "638",
            PermissibleValue(text="638", description="Numeric code for Reunion."),
        )
        setattr(
            cls,
            "646",
            PermissibleValue(text="646", description="Numeric code for Rwanda."),
        )
        setattr(
            cls,
            "642",
            PermissibleValue(text="642", description="Numeric code for Romania."),
        )
        setattr(
            cls,
            "643",
        ...
        setattr(
            cls,
            "894",
            PermissibleValue(text="894", description="Numeric code for Zambia."),
        )
        setattr(
            cls,
            "882",
            PermissibleValue(text="882", description="Numeric code for Samoa."),
        )
        setattr(
            cls,
            "674",
            PermissibleValue(text="674", description="Numeric code for San Marino."),
        )
        setattr(
            cls,
            "678",
        ...
        setattr(
            cls,
            "682",
            PermissibleValue(text="682", description="Numeric code for Saudi Arabia."),
        )
        setattr(
            cls,
            "752",
            PermissibleValue(text="752", description="Numeric code for Sweden."),
        )
        setattr(
            cls,
            "756",
            PermissibleValue(text="756", description="Numeric code for Switzerland."),
        )
        setattr(
            cls,
            "686",
            PermissibleValue(text="686", description="Numeric code for Senegal."),
        )
        setattr(
            cls,
            "688",
            PermissibleValue(text="688", description="Numeric code for Serbia."),
        )
        setattr(
            cls,
            "690",
            PermissibleValue(text="690", description="Numeric code for Seychelles."),
        )
        setattr(
            cls,
            "694",
            PermissibleValue(text="694", description="Numeric code for Sierra Leone."),
        )
        setattr(
            cls,
            "716",
            PermissibleValue(text="716", description="Numeric code for Zimbabwe."),
        )
        setattr(
            cls,
            "702",
            PermissibleValue(text="702", description="Numeric code for Singapore."),
        )
        setattr(
            cls,
            "703",
            PermissibleValue(text="703", description="Numeric code for Slovakia."),
        )
        setattr(
            cls,
            "705",
            PermissibleValue(text="705", description="Numeric code for Slovenia."),
        )
        setattr(
            cls,
            "706",
            PermissibleValue(text="706", description="Numeric code for Somalia."),
        )
        setattr(
            cls,
            "724",
            PermissibleValue(text="724", description="Numeric code for Spain."),
        )
        setattr(
            cls,
            "144",
            PermissibleValue(text="144", description="Numeric code for Sri Lanka."),
        )
        setattr(
            cls,
            "652",
        ...
        setattr(
            cls,
            "662",
            PermissibleValue(text="662", description="Numeric code for Saint Lucia."),
        )
        setattr(
            cls,
            "663",
            PermissibleValue(
                text="663", description="Numeric code for Saint Martin (French part)."
            ),
        )
        setattr(
            cls,
        ...
        setattr(
            cls,
            "710",
            PermissibleValue(text="710", description="Numeric code for South Africa."),
        )
        setattr(
            cls,
            "729",
            PermissibleValue(text="729", description="Numeric code forSudan (the)."),
        )
        setattr(
            cls,
            "239",
        ...
        setattr(
            cls,
            "728",
            PermissibleValue(text="728", description="Numeric code for South Sudan."),
        )
        setattr(
            cls,
            "740",
            PermissibleValue(text="740", description="Numeric code for Suriname."),
        )
        setattr(
            cls,
            "744",
        ...
        setattr(
            cls,
            "748",
            PermissibleValue(text="748", description="Numeric code for Eswatini."),
        )
        setattr(
            cls,
            "762",
            PermissibleValue(text="762", description="Numeric code for Tajikistan."),
        )
        setattr(
            cls,
            "158",
            PermissibleValue(
                text="158", description="Numeric code for Taiwan (Province of China)."
            ),
        )
        setattr(
            cls,
            "764",
            PermissibleValue(text="764", description="Numeric code for Thailand."),
        )
        setattr(
            cls,
            "626",
            PermissibleValue(text="626", description="Numeric code for Timor-Leste."),
        )
        setattr(
            cls,
            "768",
            PermissibleValue(text="768", description="Numeric code for Togo."),
        )
        setattr(
            cls,
            "772",
            PermissibleValue(text="772", description="Numeric code for Tokelau."),
        )
        setattr(
            cls,
            "776",
            PermissibleValue(text="776", description="Numeric code for Tonga."),
        )
        setattr(
            cls,
            "780",
        ...
        setattr(
            cls,
            "148",
            PermissibleValue(text="148", description="Numeric code for Chad."),
        )
        setattr(
            cls,
            "203",
            PermissibleValue(text="203", description="Numeric code for Czechia."),
        )
        setattr(
            cls,
            "788",
            PermissibleValue(text="788", description="Numeric code for Tunisia."),
        )
        setattr(
            cls,
            "792",
            PermissibleValue(text="792", description="Numeric code for Turkey."),
        )
        setattr(
            cls,
            "795",
            PermissibleValue(text="795", description="Numeric code for Turkmenistan."),
        )
        setattr(
            cls,
            "796",
        ...
        setattr(
            cls,
            "798",
            PermissibleValue(text="798", description="Numeric code for Tuvalu."),
        )
        setattr(
            cls,
            "800",
            PermissibleValue(text="800", description="Numeric code for Uganda."),
        )
        setattr(
            cls,
            "804",
            PermissibleValue(text="804", description="Numeric code for Ukraine."),
        )
        setattr(
            cls,
            "348",
            PermissibleValue(text="348", description="Numeric code for Hungary."),
        )
        setattr(
            cls,
            "858",
            PermissibleValue(text="858", description="Numeric code for Uruguay."),
        )
        setattr(
            cls,
            "860",
            PermissibleValue(text="860", description="Numeric code for Uzbekistan."),
        )
        setattr(
            cls,
            "548",
            PermissibleValue(text="548", description="Numeric code for Vanuatu."),
        )
        setattr(
            cls,
            "336",
        ...
        setattr(
            ...
            "784",
            PermissibleValue(
                text="784", description="Numeric code for United Arab Emirates (the)."
            ),
        )
        setattr(
            cls,
            "834",
            PermissibleValue(
                text="834", description="Numeric code for Tanzania, United Republic of."
            ),
        )
        setattr(
            cls,
        ...
        setattr(
            cls,
            "704",
            PermissibleValue(text="704", description="Numeric code for Viet Nam."),
        )
        setattr(
            cls,
            "876",
        ...
        setattr(
            cls,
            "112",
            PermissibleValue(text="112", description="Numeric code for Belarus."),
        )
        setattr(
            cls,
            "732",
        ...
        setattr(
            cls,
            "196",
            PermissibleValue(text="196", description="Numeric code for Cyprus."),
        )
...
class SignatureAlgorithm(EnumDefinitionImpl):
    ...
    ECKDSA = PermissibleValue(
        text="ECKDSA", description="Elliptic Curve variant of the KCDSA algorithm."
    )
...
class GPUInterconnetionTypes(EnumDefinitionImpl):
    ...
    @classmethod
    def _addvals(cls):
        setattr(cls, "Xe Link", PermissibleValue(text="Xe Link"))
        setattr(cls, "Infinity Fabric", PermissibleValue(text="Infinity Fabric"))
...
class UpdateFrequency(EnumDefinitionImpl):
    ...
    yearly = PermissibleValue(
        text="yearly", description="Image will be updated at least once per year."
    )
    quarterly = PermissibleValue(
        text="quarterly", description="Image will be updated at least once per quarter."
    )
    monthly = PermissibleValue(
        text="monthly", description="Image will be updated at least once per month."
    )
    weekly = PermissibleValue(
        text="weekly", description="Image will be updated at least once per week."
    )
    daily = PermissibleValue(
        text="daily", description="Image will be updated at least once per day."
    )
    critical_bug = PermissibleValue(
        text="critical_bug", description="Image will be updated for critical bugs only."
    )
    never = PermissibleValue(text="never", description="Image will never be updated.")
...
class Validity1(EnumDefinitionImpl):
    ...
    none = PermissibleValue(text="none", description="No information are given.")
...
class OSDistribution(EnumDefinitionImpl):
    ...
    @classmethod
    def _addvals(cls):
        setattr(cls, "Alpine Linux", PermissibleValue(text="Alpine Linux"))
        setattr(cls, "Arch Linux", PermissibleValue(text="Arch Linux"))
        setattr(cls, "CentOS Linux", PermissibleValue(text="CentOS Linux"))
        setattr(cls, "Gentoo Linux", PermissibleValue(text="Gentoo Linux"))
        setattr(cls, "Mandriva Linux", PermissibleValue(text="Mandriva Linux"))
        setattr(
            cls,
            "Mandriva Enterprise Server",
            PermissibleValue(text="Mandriva Enterprise Server"),
        )
        setattr(cls, "MS-DOS", PermissibleValue(text="MS-DOS"))
        setattr(cls, "Novell NetWare", PermissibleValue(text="Novell NetWare"))
        setattr(cls, "Rocky Linux", PermissibleValue(text="Rocky Linux"))
        setattr(
            cls,
...
class HypervisorType(EnumDefinitionImpl):
    ...
    @classmethod
    def _addvals(cls):
        setattr(cls, "Hyper-V", PermissibleValue(text="Hyper-V"))
        setattr(cls, "Cloud Hypervisor", PermissibleValue(text="Cloud Hypervisor"))
...
class PersonalDataProtectionRegime(EnumDefinitionImpl):
    ...
    PDPA2012 = PermissibleValue(
        text="PDPA2012", description="Personal Data Protection Act 2012 / SGP."
    )
    CCPA2018 = PermissibleValue(
        text="CCPA2018", description="California Consumer Privacy Act / US-CA."
    )
    VCDPA2021 = PermissibleValue(
        text="VCDPA2021", description="Virginia Consumer Data Protection Act / US-VA."
    )
...
class MIMETypes(EnumDefinitionImpl):
    ...
    def _addvals(cls):
        ...
        setattr(cls, "cache-manifest", PermissibleValue(text="cache-manifest"))
        setattr(cls, "cql-expression", PermissibleValue(text="cql-expression"))
        setattr(cls, "cql-identifier", PermissibleValue(text="cql-identifier"))
        setattr(cls, "csv-schema", PermissibleValue(text="csv-schema"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.exchangeable", PermissibleValue(text="vnd.exchangeable"))
        setattr(
            cls,
            "vnd.familysearch.gedcom",
            PermissibleValue(text="vnd.familysearch.gedcom"),
        )
        setattr(cls, "vnd.ficlab.flt", PermissibleValue(text="vnd.ficlab.flt"))
        setattr(cls, "vnd.fly", PermissibleValue(text="vnd.fly"))
        setattr(cls, "vnd.fmi.flexstor", PermissibleValue(text="vnd.fmi.flexstor"))
        setattr(cls, "vnd.gml", PermissibleValue(text="vnd.gml"))
        setattr(cls, "vnd.graphviz", PermissibleValue(text="vnd.graphviz"))
        setattr(cls, "vnd.hans", PermissibleValue(text="vnd.hans"))
        setattr(cls, "vnd.hgl", PermissibleValue(text="vnd.hgl"))
        setattr(cls, "vnd.in3d.3dml", PermissibleValue(text="vnd.in3d.3dml"))
        setattr(cls, "vnd.in3d.spot", PermissibleValue(text="vnd.in3d.spot"))
        ...
        setattr(cls, "vnd.sosi", PermissibleValue(text="vnd.sosi"))
        setattr(
            cls,
            "vnd.trolltech.linguist",
            PermissibleValue(text="vnd.trolltech.linguist"),
        )
        setattr(cls, "vnd.wap.si", PermissibleValue(text="vnd.wap.si"))
        setattr(cls, "vnd.wap.sl", PermissibleValue(text="vnd.wap.sl"))
        setattr(cls, "vnd.wap.wml", PermissibleValue(text="vnd.wap.wml"))
        setattr(cls, "vnd.wap.wmlscript", PermissibleValue(text="vnd.wap.wmlscript"))
        setattr(
            cls,
        ...
        setattr(cls, "3gppHal+json", PermissibleValue(text="3gppHal+json"))
        setattr(cls, "3gppHalForms+json", PermissibleValue(text="3gppHalForms+json"))
        setattr(cls, "3gpp-ims+xml", PermissibleValue(text="3gpp-ims+xml"))
        setattr(cls, "ace+cbor", PermissibleValue(text="ace+cbor"))
        setattr(cls, "ace+json", PermissibleValue(text="ace+json"))
        setattr(cls, "activity+json", PermissibleValue(text="activity+json"))
        ...
        setattr(cls, "alto-error+json", PermissibleValue(text="alto-error+json"))
        setattr(
            cls,
        ...
        setattr(cls, "andrew-inset", PermissibleValue(text="andrew-inset"))
        setattr(cls, "at+jwt", PermissibleValue(text="at+jwt"))
        setattr(cls, "atom+xml", PermissibleValue(text="atom+xml"))
        setattr(cls, "atomcat+xml", PermissibleValue(text="atomcat+xml"))
        setattr(cls, "atomdeleted+xml", PermissibleValue(text="atomdeleted+xml"))
        setattr(cls, "atomsvc+xml", PermissibleValue(text="atomsvc+xml"))
        setattr(cls, "atsc-dwd+xml", PermissibleValue(text="atsc-dwd+xml"))
        setattr(
            cls,
            "atsc-dynamic-event-message",
            PermissibleValue(text="atsc-dynamic-event-message"),
        )
        setattr(cls, "atsc-held+xml", PermissibleValue(text="atsc-held+xml"))
        ...
        setattr(cls, "calendar+json", PermissibleValue(text="calendar+json"))
        setattr(cls, "calendar+xml", PermissibleValue(text="calendar+xml"))
        setattr(cls, "call-completion", PermissibleValue(text="call-completion"))
        setattr(cls, "CALS-1840", PermissibleValue(text="CALS-1840"))
        setattr(cls, "captive+json", PermissibleValue(text="captive+json"))
        setattr(cls, "cbor-seq", PermissibleValue(text="cbor-seq"))
        setattr(cls, "ccmp+xml", PermissibleValue(text="ccmp+xml"))
        setattr(cls, "ccxml+xml", PermissibleValue(text="ccxml+xml"))
        setattr(cls, "cda+xml", PermissibleValue(text="cda+xml"))
        setattr(cls, "CDFX+XML", PermissibleValue(text="CDFX+XML"))
        setattr(cls, "cdmi-capability", PermissibleValue(text="cdmi-capability"))
        setattr(cls, "cdmi-container", PermissibleValue(text="cdmi-container"))
        setattr(cls, "cdmi-domain", PermissibleValue(text="cdmi-domain"))
        setattr(cls, "cdmi-object", PermissibleValue(text="cdmi-object"))
        setattr(cls, "cdmi-queue", PermissibleValue(text="cdmi-queue"))
        setattr(cls, "cea-2018+xml", PermissibleValue(text="cea-2018+xml"))
        setattr(cls, "cellml+xml", PermissibleValue(text="cellml+xml"))
        setattr(cls, "cid-edhoc+cbor-seq", PermissibleValue(text="cid-edhoc+cbor-seq"))
        setattr(cls, "city+json", PermissibleValue(text="city+json"))
        setattr(cls, "clue_info+xml", PermissibleValue(text="clue_info+xml"))
        setattr(cls, "clue+xml", PermissibleValue(text="clue+xml"))
        setattr(cls, "cnrp+xml", PermissibleValue(text="cnrp+xml"))
        setattr(cls, "coap-group+json", PermissibleValue(text="coap-group+json"))
        setattr(cls, "coap-payload", PermissibleValue(text="coap-payload"))
        setattr(
            cls,
        ...
        setattr(cls, "cose-x509", PermissibleValue(text="cose-x509"))
        setattr(cls, "csta+xml", PermissibleValue(text="csta+xml"))
        setattr(cls, "CSTAdata+xml", PermissibleValue(text="CSTAdata+xml"))
        setattr(cls, "csvm+json", PermissibleValue(text="csvm+json"))
        setattr(cls, "cwl+json", PermissibleValue(text="cwl+json"))
        setattr(cls, "dash+xml", PermissibleValue(text="dash+xml"))
        setattr(cls, "dash-patch+xml", PermissibleValue(text="dash-patch+xml"))
        setattr(cls, "davmount+xml", PermissibleValue(text="davmount+xml"))
        setattr(cls, "dca-rft", PermissibleValue(text="dca-rft"))
        setattr(cls, "dec-dx", PermissibleValue(text="dec-dx"))
        setattr(cls, "dialog-info+xml", PermissibleValue(text="dialog-info+xml"))
        setattr(cls, "dicom+json", PermissibleValue(text="dicom+json"))
        setattr(cls, "dicom+xml", PermissibleValue(text="dicom+xml"))
        setattr(cls, "dns+json", PermissibleValue(text="dns+json"))
        setattr(cls, "dns-message", PermissibleValue(text="dns-message"))
        setattr(cls, "dots+cbor", PermissibleValue(text="dots+cbor"))
        setattr(cls, "dpop+jwt", PermissibleValue(text="dpop+jwt"))
        setattr(cls, "dskpp+xml", PermissibleValue(text="dskpp+xml"))
        setattr(cls, "dssc+der", PermissibleValue(text="dssc+der"))
        setattr(cls, "dssc+xml", PermissibleValue(text="dssc+xml"))
        setattr(cls, "edhoc+cbor-seq", PermissibleValue(text="edhoc+cbor-seq"))
        setattr(cls, "EDI-consent", PermissibleValue(text="EDI-consent"))
        setattr(cls, "EDI-X12", PermissibleValue(text="EDI-X12"))
        setattr(cls, "elm+json", PermissibleValue(text="elm+json"))
        setattr(cls, "elm+xml", PermissibleValue(text="elm+xml"))
        setattr(
            cls,
        ...
        setattr(cls, "emma+xml", PermissibleValue(text="emma+xml"))
        ...
        setattr(cls, "font-tdpfr", PermissibleValue(text="font-tdpfr"))
        setattr(
            cls,
        ...
        setattr(cls, "geo+json", PermissibleValue(text="geo+json"))
        setattr(cls, "geo+json-seq", PermissibleValue(text="geo+json-seq"))
        setattr(cls, "geopackage+sqlite3", PermissibleValue(text="geopackage+sqlite3"))
        setattr(cls, "geoxacml+xml", PermissibleValue(text="geoxacml+xml"))
        setattr(cls, "gltf-buffer", PermissibleValue(text="gltf-buffer"))
        ...
        setattr(cls, "index.cmd", PermissibleValue(text="index.cmd"))
        setattr(cls, "index.obj", PermissibleValue(text="index.obj"))
        setattr(cls, "index.response", PermissibleValue(text="index.response"))
        setattr(cls, "index.vnd", PermissibleValue(text="index.vnd"))
        setattr(cls, "inkml+xml", PermissibleValue(text="inkml+xml"))
        setattr(cls, "its+xml", PermissibleValue(text="its+xml"))
        setattr(cls, "java-archive", PermissibleValue(text="java-archive"))
        setattr(
            cls,
            "javascript (OBSOLETED in favor of text/javascript)",
            PermissibleValue(text="javascript (OBSOLETED in favor of text/javascript)"),
        )
        setattr(cls, "jf2feed+json", PermissibleValue(text="jf2feed+json"))
        setattr(cls, "jose+json", PermissibleValue(text="jose+json"))
        setattr(cls, "jrd+json", PermissibleValue(text="jrd+json"))
        setattr(cls, "jscalendar+json", PermissibleValue(text="jscalendar+json"))
        setattr(cls, "json-patch+json", PermissibleValue(text="json-patch+json"))
        setattr(cls, "json-seq", PermissibleValue(text="json-seq"))
        setattr(cls, "jwk+json", PermissibleValue(text="jwk+json"))
        setattr(cls, "jwk-set+json", PermissibleValue(text="jwk-set+json"))
        setattr(cls, "kpml-request+xml", PermissibleValue(text="kpml-request+xml"))
        setattr(cls, "kpml-response+xml", PermissibleValue(text="kpml-response+xml"))
        setattr(cls, "ld+json", PermissibleValue(text="ld+json"))
        setattr(cls, "lgr+xml", PermissibleValue(text="lgr+xml"))
        setattr(cls, "link-format", PermissibleValue(text="link-format"))
        setattr(cls, "linkset+json", PermissibleValue(text="linkset+json"))
        setattr(cls, "load-control+xml", PermissibleValue(text="load-control+xml"))
        setattr(cls, "logout+jwt", PermissibleValue(text="logout+jwt"))
        setattr(cls, "lost+xml", PermissibleValue(text="lost+xml"))
        setattr(cls, "lostsync+xml", PermissibleValue(text="lostsync+xml"))
        setattr(cls, "lpf+zip", PermissibleValue(text="lpf+zip"))
        setattr(cls, "mac-binhex40", PermissibleValue(text="mac-binhex40"))
        setattr(cls, "mads+xml", PermissibleValue(text="mads+xml"))
        setattr(cls, "manifest+json", PermissibleValue(text="manifest+json"))
        setattr(cls, "marcxml+xml", PermissibleValue(text="marcxml+xml"))
        setattr(cls, "mathml+xml", PermissibleValue(text="mathml+xml"))
        setattr(cls, "mathml-content+xml", PermissibleValue(text="mathml-content+xml"))
        setattr(
            cls,
        ...
        setattr(cls, "mbms-register+xml", PermissibleValue(text="mbms-register+xml"))
        setattr(cls, "mbms-schedule+xml", PermissibleValue(text="mbms-schedule+xml"))
        setattr(
            cls,
            "mbms-user-service-description+xml",
            PermissibleValue(text="mbms-user-service-description+xml"),
        )
        setattr(cls, "media_control+xml", PermissibleValue(text="media_control+xml"))
        setattr(
            cls,
        ...
        setattr(cls, "merge-patch+json", PermissibleValue(text="merge-patch+json"))
        setattr(cls, "metalink4+xml", PermissibleValue(text="metalink4+xml"))
        setattr(cls, "mets+xml", PermissibleValue(text="mets+xml"))
        setattr(
            cls,
            "missing-blocks+cbor-seq",
            PermissibleValue(text="missing-blocks+cbor-seq"),
        )
        setattr(cls, "mmt-aei+xml", PermissibleValue(text="mmt-aei+xml"))
        setattr(cls, "mmt-usd+xml", PermissibleValue(text="mmt-usd+xml"))
        setattr(cls, "mods+xml", PermissibleValue(text="mods+xml"))
        setattr(cls, "moss-keys", PermissibleValue(text="moss-keys"))
        setattr(cls, "moss-signature", PermissibleValue(text="moss-signature"))
        setattr(cls, "mosskey-data", PermissibleValue(text="mosskey-data"))
        setattr(cls, "mosskey-request", PermissibleValue(text="mosskey-request"))
        setattr(cls, "mpeg4-generic", PermissibleValue(text="mpeg4-generic"))
        setattr(cls, "mpeg4-iod", PermissibleValue(text="mpeg4-iod"))
        setattr(cls, "mpeg4-iod-xmt", PermissibleValue(text="mpeg4-iod-xmt"))
        setattr(cls, "mrb-consumer+xml", PermissibleValue(text="mrb-consumer+xml"))
        setattr(cls, "mrb-publish+xml", PermissibleValue(text="mrb-publish+xml"))
        setattr(cls, "msc-ivr+xml", PermissibleValue(text="msc-ivr+xml"))
        setattr(cls, "msc-mixer+xml", PermissibleValue(text="msc-mixer+xml"))
        setattr(cls, "mud+json", PermissibleValue(text="mud+json"))
        setattr(cls, "multipart-core", PermissibleValue(text="multipart-core"))
        setattr(cls, "n-quads", PermissibleValue(text="n-quads"))
        setattr(cls, "n-triples", PermissibleValue(text="n-triples"))
        setattr(cls, "news-checkgroups", PermissibleValue(text="news-checkgroups"))
        ...
        setattr(cls, "odm+xml", PermissibleValue(text="odm+xml"))
        setattr(cls, "oebps-package+xml", PermissibleValue(text="oebps-package+xml"))
        setattr(cls, "ohttp-keys", PermissibleValue(text="ohttp-keys"))
        ...
        setattr(cls, "pidf-diff+xml", PermissibleValue(text="pidf-diff+xml"))
        setattr(cls, "pidf+xml", PermissibleValue(text="pidf+xml"))
        setattr(cls, "pkcs7-mime", PermissibleValue(text="pkcs7-mime"))
        setattr(cls, "pkcs7-signature", PermissibleValue(text="pkcs7-signature"))
        setattr(cls, "pkcs8-encrypted", PermissibleValue(text="pkcs8-encrypted"))
        setattr(cls, "pkix-attr-cert", PermissibleValue(text="pkix-attr-cert"))
        setattr(cls, "pkix-cert", PermissibleValue(text="pkix-cert"))
        setattr(cls, "pkix-crl", PermissibleValue(text="pkix-crl"))
        setattr(cls, "pkix-pkipath", PermissibleValue(text="pkix-pkipath"))
        setattr(cls, "pls+xml", PermissibleValue(text="pls+xml"))
        setattr(cls, "poc-settings+xml", PermissibleValue(text="poc-settings+xml"))
        setattr(cls, "ppsp-tracker+json", PermissibleValue(text="ppsp-tracker+json"))
        setattr(cls, "problem+json", PermissibleValue(text="problem+json"))
        setattr(cls, "problem+xml", PermissibleValue(text="problem+xml"))
        setattr(cls, "provenance+xml", PermissibleValue(text="provenance+xml"))
        setattr(
            cls,
            "prs.alvestrand.titrax-sheet",
            PermissibleValue(text="prs.alvestrand.titrax-sheet"),
        )
        setattr(cls, "prs.cww", PermissibleValue(text="prs.cww"))
        setattr(cls, "prs.cyn", PermissibleValue(text="prs.cyn"))
        setattr(cls, "prs.hpub+zip", PermissibleValue(text="prs.hpub+zip"))
        setattr(
            cls,
        ...
        setattr(cls, "prs.vcfbzip2", PermissibleValue(text="prs.vcfbzip2"))
        setattr(cls, "prs.xsf+xml", PermissibleValue(text="prs.xsf+xml"))
        setattr(cls, "pskc+xml", PermissibleValue(text="pskc+xml"))
        setattr(cls, "pvd+json", PermissibleValue(text="pvd+json"))
        setattr(cls, "rdf+xml", PermissibleValue(text="rdf+xml"))
        setattr(cls, "route-apd+xml", PermissibleValue(text="route-apd+xml"))
        setattr(cls, "route-s-tsid+xml", PermissibleValue(text="route-s-tsid+xml"))
        setattr(cls, "route-usd+xml", PermissibleValue(text="route-usd+xml"))
        setattr(cls, "rdap+json", PermissibleValue(text="rdap+json"))
        setattr(cls, "reginfo+xml", PermissibleValue(text="reginfo+xml"))
        setattr(
            cls,
        ...
        setattr(cls, "reputon+json", PermissibleValue(text="reputon+json"))
        setattr(
            cls,
            "resource-lists-diff+xml",
            PermissibleValue(text="resource-lists-diff+xml"),
        )
        setattr(cls, "resource-lists+xml", PermissibleValue(text="resource-lists+xml"))
        setattr(cls, "rfc+xml", PermissibleValue(text="rfc+xml"))
        setattr(cls, "rlmi+xml", PermissibleValue(text="rlmi+xml"))
        setattr(cls, "rls-services+xml", PermissibleValue(text="rls-services+xml"))
        setattr(cls, "rpki-checklist", PermissibleValue(text="rpki-checklist"))
        setattr(cls, "rpki-ghostbusters", PermissibleValue(text="rpki-ghostbusters"))
        setattr(cls, "rpki-manifest", PermissibleValue(text="rpki-manifest"))
        setattr(cls, "rpki-publication", PermissibleValue(text="rpki-publication"))
        setattr(cls, "rpki-roa", PermissibleValue(text="rpki-roa"))
        setattr(cls, "rpki-updown", PermissibleValue(text="rpki-updown"))
        setattr(cls, "samlassertion+xml", PermissibleValue(text="samlassertion+xml"))
        setattr(cls, "samlmetadata+xml", PermissibleValue(text="samlmetadata+xml"))
        setattr(
            cls,
            "sarif-external-properties+json",
            PermissibleValue(text="sarif-external-properties+json"),
        )
        setattr(cls, "sarif+json", PermissibleValue(text="sarif+json"))
        setattr(cls, "sbml+xml", PermissibleValue(text="sbml+xml"))
        setattr(cls, "scaip+xml", PermissibleValue(text="scaip+xml"))
        setattr(cls, "scim+json", PermissibleValue(text="scim+json"))
        setattr(cls, "scvp-cv-request", PermissibleValue(text="scvp-cv-request"))
        setattr(cls, "scvp-cv-response", PermissibleValue(text="scvp-cv-response"))
        setattr(cls, "scvp-vp-request", PermissibleValue(text="scvp-vp-request"))
        setattr(cls, "scvp-vp-response", PermissibleValue(text="scvp-vp-response"))
        setattr(cls, "secevent+jwt", PermissibleValue(text="secevent+jwt"))
        setattr(cls, "senml-etch+cbor", PermissibleValue(text="senml-etch+cbor"))
        setattr(cls, "senml-etch+json", PermissibleValue(text="senml-etch+json"))
        setattr(cls, "senml-exi", PermissibleValue(text="senml-exi"))
        setattr(cls, "senml+cbor", PermissibleValue(text="senml+cbor"))
        setattr(cls, "senml+json", PermissibleValue(text="senml+json"))
        setattr(cls, "senml+xml", PermissibleValue(text="senml+xml"))
        setattr(cls, "sensml-exi", PermissibleValue(text="sensml-exi"))
        setattr(cls, "sensml+cbor", PermissibleValue(text="sensml+cbor"))
        setattr(cls, "sensml+json", PermissibleValue(text="sensml+json"))
        setattr(cls, "sensml+xml", PermissibleValue(text="sensml+xml"))
        setattr(cls, "sep-exi", PermissibleValue(text="sep-exi"))
        setattr(cls, "sep+xml", PermissibleValue(text="sep+xml"))
        setattr(cls, "session-info", PermissibleValue(text="session-info"))
        setattr(cls, "set-payment", PermissibleValue(text="set-payment"))
        setattr(
            cls,
            "set-payment-initiation",
            PermissibleValue(text="set-payment-initiation"),
        )
        setattr(cls, "set-registration", PermissibleValue(text="set-registration"))
        setattr(
            cls,
            "set-registration-initiation",
            PermissibleValue(text="set-registration-initiation"),
        )
        setattr(cls, "sgml-open-catalog", PermissibleValue(text="sgml-open-catalog"))
        setattr(cls, "shf+xml", PermissibleValue(text="shf+xml"))
        setattr(cls, "simple-filter+xml", PermissibleValue(text="simple-filter+xml"))
        setattr(
            cls,
        ...
        setattr(cls, "smil+xml", PermissibleValue(text="smil+xml"))
        setattr(cls, "soap+fastinfoset", PermissibleValue(text="soap+fastinfoset"))
        setattr(cls, "soap+xml", PermissibleValue(text="soap+xml"))
        setattr(cls, "sparql-query", PermissibleValue(text="sparql-query"))
        setattr(cls, "spdx+json", PermissibleValue(text="spdx+json"))
        setattr(cls, "sparql-results+xml", PermissibleValue(text="sparql-results+xml"))
        setattr(cls, "spirits-event+xml", PermissibleValue(text="spirits-event+xml"))
        setattr(cls, "srgs+xml", PermissibleValue(text="srgs+xml"))
        setattr(cls, "sru+xml", PermissibleValue(text="sru+xml"))
        setattr(cls, "ssml+xml", PermissibleValue(text="ssml+xml"))
        setattr(cls, "stix+json", PermissibleValue(text="stix+json"))
        setattr(cls, "swid+cbor", PermissibleValue(text="swid+cbor"))
        setattr(cls, "swid+xml", PermissibleValue(text="swid+xml"))
        setattr(cls, "tamp-apex-update", PermissibleValue(text="tamp-apex-update"))
        setattr(
            cls,
        ...
        setattr(cls, "thraud+xml", PermissibleValue(text="thraud+xml"))
        setattr(cls, "timestamp-query", PermissibleValue(text="timestamp-query"))
        setattr(cls, "timestamp-reply", PermissibleValue(text="timestamp-reply"))
        setattr(cls, "timestamped-data", PermissibleValue(text="timestamped-data"))
        setattr(cls, "tlsrpt+gzip", PermissibleValue(text="tlsrpt+gzip"))
        setattr(cls, "tlsrpt+json", PermissibleValue(text="tlsrpt+json"))
        setattr(cls, "tm+json", PermissibleValue(text="tm+json"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.1ob", PermissibleValue(text="vnd.1ob"))
        setattr(cls, "vnd.3gpp.5gnas", PermissibleValue(text="vnd.3gpp.5gnas"))
        setattr(
            cls,
            "vnd.3gpp.access-transfer-events+xml",
            PermissibleValue(text="vnd.3gpp.access-transfer-events+xml"),
        )
        setattr(cls, "vnd.3gpp.bsf+xml", PermissibleValue(text="vnd.3gpp.bsf+xml"))
        setattr(cls, "vnd.3gpp.crs+xml", PermissibleValue(text="vnd.3gpp.crs+xml"))
        setattr(
            cls,
            "vnd.3gpp.current-location-discovery+xml",
            PermissibleValue(text="vnd.3gpp.current-location-discovery+xml"),
        )
        setattr(cls, "vnd.3gpp.GMOP+xml", PermissibleValue(text="vnd.3gpp.GMOP+xml"))
        setattr(cls, "vnd.3gpp.gtpc", PermissibleValue(text="vnd.3gpp.gtpc"))
        setattr(
            cls,
            "vnd.3gpp.interworking-data",
            PermissibleValue(text="vnd.3gpp.interworking-data"),
        )
        setattr(cls, "vnd.3gpp.lpp", PermissibleValue(text="vnd.3gpp.lpp"))
        setattr(
            cls,
        ...
        setattr(
            ...
            PermissibleValue(
                text="vnd.3gpp.mcvideo-affiliation-info+xml (OBSOLETED in favor of application/vnd.3gpp.mcvideo-info+xml)"
            ),
        )
        setattr(
            cls,
        ...
        setattr(cls, "vnd.3gpp-prose+xml", PermissibleValue(text="vnd.3gpp-prose+xml"))
        setattr(cls, "vnd.3gpp.s1ap", PermissibleValue(text="vnd.3gpp.s1ap"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.3gpp.sms", PermissibleValue(text="vnd.3gpp.sms"))
        setattr(cls, "vnd.3gpp.sms+xml", PermissibleValue(text="vnd.3gpp.sms+xml"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.3gpp2.sms", PermissibleValue(text="vnd.3gpp2.sms"))
        setattr(cls, "vnd.3gpp2.tcap", PermissibleValue(text="vnd.3gpp2.tcap"))
        setattr(cls, "vnd.3gpp.v2x", PermissibleValue(text="vnd.3gpp.v2x"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.adobe.fxp", PermissibleValue(text="vnd.adobe.fxp"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.afpc.modca", PermissibleValue(text="vnd.afpc.modca"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.age", PermissibleValue(text="vnd.age"))
        setattr(cls, "vnd.ah-barcode", PermissibleValue(text="vnd.ah-barcode"))
        setattr(cls, "vnd.ahead.space", PermissibleValue(text="vnd.ahead.space"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.amadeus+json", PermissibleValue(text="vnd.amadeus+json"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.apexlang", PermissibleValue(text="vnd.apexlang"))
        setattr(cls, "vnd.api+json", PermissibleValue(text="vnd.api+json"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.apple.keynote", PermissibleValue(text="vnd.apple.keynote"))
        setattr(cls, "vnd.apple.mpegurl", PermissibleValue(text="vnd.apple.mpegurl"))
        setattr(cls, "vnd.apple.numbers", PermissibleValue(text="vnd.apple.numbers"))
        setattr(cls, "vnd.apple.pages", PermissibleValue(text="vnd.apple.pages"))
        setattr(
            cls,
            "vnd.arastra.swi (OBSOLETED in favor of application/vnd.aristanetworks.swi)",
            PermissibleValue(
                text="vnd.arastra.swi (OBSOLETED in favor of application/vnd.aristanetworks.swi)"
            ),
        )
        setattr(
            cls,
        ...
        setattr(cls, "vnd.artisan+json", PermissibleValue(text="vnd.artisan+json"))
        setattr(cls, "vnd.artsquare", PermissibleValue(text="vnd.artsquare"))
        setattr(
            cls,
            "vnd.astraea-software.iota",
            PermissibleValue(text="vnd.astraea-software.iota"),
        )
        setattr(cls, "vnd.audiograph", PermissibleValue(text="vnd.audiograph"))
        ...
        setattr(cls, "vnd.canon-lips", PermissibleValue(text="vnd.canon-lips"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.chemdraw+xml", PermissibleValue(text="vnd.chemdraw+xml"))
        setattr(cls, "vnd.chess-pgn", PermissibleValue(text="vnd.chess-pgn"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.claymore", PermissibleValue(text="vnd.claymore"))
        setattr(cls, "vnd.cloanto.rp9", PermissibleValue(text="vnd.cloanto.rp9"))
        setattr(cls, "vnd.clonk.c4group", PermissibleValue(text="vnd.clonk.c4group"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.coffeescript", PermissibleValue(text="vnd.coffeescript"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.cosmocaller", PermissibleValue(text="vnd.cosmocaller"))
        setattr(cls, "vnd.contact.cmsg", PermissibleValue(text="vnd.contact.cmsg"))
        setattr(cls, "vnd.crick.clicker", PermissibleValue(text="vnd.crick.clicker"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.cybank", PermissibleValue(text="vnd.cybank"))
        setattr(cls, "vnd.cyclonedx+json", PermissibleValue(text="vnd.cyclonedx+json"))
        setattr(cls, "vnd.cyclonedx+xml", PermissibleValue(text="vnd.cyclonedx+xml"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.desmume.movie", PermissibleValue(text="vnd.desmume.movie"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.dolby.mobile.2", PermissibleValue(text="vnd.dolby.mobile.2"))
        setattr(
            cls,
            "vnd.doremir.scorecloud-binary-document",
            PermissibleValue(text="vnd.doremir.scorecloud-binary-document"),
        )
        setattr(cls, "vnd.dpgraph", PermissibleValue(text="vnd.dpgraph"))
        ...
        setattr(cls, "vnd.dvb.pfr", PermissibleValue(text="vnd.dvb.pfr"))
        setattr(cls, "vnd.dvb.service", PermissibleValue(text="vnd.dvb.service"))
        setattr(cls, "vnd.dxr", PermissibleValue(text="vnd.dxr"))
        setattr(cls, "vnd.dynageo", PermissibleValue(text="vnd.dynageo"))
        setattr(cls, "vnd.dzr", PermissibleValue(text="vnd.dzr"))
        setattr(
            cls,
            "vnd.easykaraoke.cdgdownload",
            PermissibleValue(text="vnd.easykaraoke.cdgdownload"),
        )
        setattr(cls, "vnd.ecip.rlp", PermissibleValue(text="vnd.ecip.rlp"))
        setattr(cls, "vnd.ecdis-update", PermissibleValue(text="vnd.ecdis-update"))
        setattr(
            cls,
            "vnd.eclipse.ditto+json",
            PermissibleValue(text="vnd.eclipse.ditto+json"),
        )
        setattr(cls, "vnd.ecowin.chart", PermissibleValue(text="vnd.ecowin.chart"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.efi.img", PermissibleValue(text="vnd.efi.img"))
        setattr(cls, "vnd.efi.iso", PermissibleValue(text="vnd.efi.iso"))
        setattr(cls, "vnd.eln+zip", PermissibleValue(text="vnd.eln+zip"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.etsi.mcid+xml", PermissibleValue(text="vnd.etsi.mcid+xml"))
        setattr(cls, "vnd.etsi.mheg5", PermissibleValue(text="vnd.etsi.mheg5"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.etsi.tsl+xml", PermissibleValue(text="vnd.etsi.tsl+xml"))
        setattr(cls, "vnd.etsi.tsl.der", PermissibleValue(text="vnd.etsi.tsl.der"))
        setattr(
            cls,
            "vnd.eu.kasparian.car+json",
            PermissibleValue(text="vnd.eu.kasparian.car+json"),
        )
        setattr(cls, "vnd.eudora.data", PermissibleValue(text="vnd.eudora.data"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.fdsn.mseed", PermissibleValue(text="vnd.fdsn.mseed"))
        setattr(cls, "vnd.fdsn.seed", PermissibleValue(text="vnd.fdsn.seed"))
        setattr(cls, "vnd.ffsns", PermissibleValue(text="vnd.ffsns"))
        setattr(cls, "vnd.ficlab.flb+zip", PermissibleValue(text="vnd.ficlab.flb+zip"))
        setattr(cls, "vnd.filmit.zfc", PermissibleValue(text="vnd.filmit.zfc"))
        setattr(cls, "vnd.fints", PermissibleValue(text="vnd.fints"))
        setattr(
            cls,
            "vnd.firemonkeys.cloudcell",
            PermissibleValue(text="vnd.firemonkeys.cloudcell"),
        )
        setattr(cls, "vnd.FloGraphIt", PermissibleValue(text="vnd.FloGraphIt"))
        setattr(cls, "vnd.fluxtime.clip", PermissibleValue(text="vnd.fluxtime.clip"))
        setattr(
            cls,
            "vnd.font-fontforge-sfd",
            PermissibleValue(text="vnd.font-fontforge-sfd"),
        )
        setattr(cls, "vnd.framemaker", PermissibleValue(text="vnd.framemaker"))
        setattr(cls, "vnd.freelog.comic", PermissibleValue(text="vnd.freelog.comic"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.fsc.weblaunch", PermissibleValue(text="vnd.fsc.weblaunch"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.fujixerox.HBPL", PermissibleValue(text="vnd.fujixerox.HBPL"))
        setattr(cls, "vnd.fut-misnet", PermissibleValue(text="vnd.fut-misnet"))
        ...
        setattr(
            ...
            PermissibleValue(
                text="vnd.geo+json (OBSOLETED by [RFC7946] in favor of application/geo+json)"
            ),
        )
        setattr(
            cls,
        ...
        setattr(cls, "vnd.gerber", PermissibleValue(text="vnd.gerber"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.gpxsee.map+xml", PermissibleValue(text="vnd.gpxsee.map+xml"))
        setattr(cls, "vnd.grafeq", PermissibleValue(text="vnd.grafeq"))
        setattr(cls, "vnd.gridmp", PermissibleValue(text="vnd.gridmp"))
        setattr(cls, "vnd.groove-account", PermissibleValue(text="vnd.groove-account"))
        setattr(cls, "vnd.groove-help", PermissibleValue(text="vnd.groove-help"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.groove-vcard", PermissibleValue(text="vnd.groove-vcard"))
        setattr(cls, "vnd.hal+json", PermissibleValue(text="vnd.hal+json"))
        setattr(cls, "vnd.hal+xml", PermissibleValue(text="vnd.hal+xml"))
        setattr(
            cls,
            "vnd.HandHeld-Entertainment+xml",
            PermissibleValue(text="vnd.HandHeld-Entertainment+xml"),
        )
        setattr(cls, "vnd.hbci", PermissibleValue(text="vnd.hbci"))
        setattr(cls, "vnd.hc+json", PermissibleValue(text="vnd.hc+json"))
        ...
        setattr(cls, "vnd.hp-jlyt", PermissibleValue(text="vnd.hp-jlyt"))
        setattr(cls, "vnd.hp-PCL", PermissibleValue(text="vnd.hp-PCL"))
        setattr(cls, "vnd.hp-PCLXL", PermissibleValue(text="vnd.hp-PCLXL"))
        setattr(cls, "vnd.hsl", PermissibleValue(text="vnd.hsl"))
        setattr(cls, "vnd.httphone", PermissibleValue(text="vnd.httphone"))
        setattr(
            cls,
        ...
        setattr(
            ...
            PermissibleValue(
                text="vnd.ibm.afplinedata (OBSOLETED in favor of vnd.afpc.afplinedata)"
            ),
        )
        setattr(
            cls,
        ...
        setattr(cls, "vnd.ibm.MiniPay", PermissibleValue(text="vnd.ibm.MiniPay"))
        setattr(
            cls,
            "vnd.ibm.modcap (OBSOLETED in favor of application/vnd.afpc.modca)",
            PermissibleValue(
                text="vnd.ibm.modcap (OBSOLETED in favor of application/vnd.afpc.modca)"
            ),
        )
        setattr(
            cls,
        ...
        setattr(cls, "vnd.iccprofile", PermissibleValue(text="vnd.iccprofile"))
        setattr(cls, "vnd.ieee.1905", PermissibleValue(text="vnd.ieee.1905"))
        setattr(cls, "vnd.igloader", PermissibleValue(text="vnd.igloader"))
        setattr(
            cls,
        ...
        setattr(
            ...
            PermissibleValue(
                text="vnd.informix-visionary (OBSOLETED in favor of application/vnd.visionary)"
            ),
        )
        setattr(
            cls,
        ...
        setattr(cls, "vnd.ipld.raw", PermissibleValue(text="vnd.ipld.raw"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.jisp", PermissibleValue(text="vnd.jisp"))
        setattr(
            cls,
            "vnd.joost.joda-archive",
            PermissibleValue(text="vnd.joost.joda-archive"),
        )
        setattr(cls, "vnd.jsk.isdn-ngn", PermissibleValue(text="vnd.jsk.isdn-ngn"))
        setattr(cls, "vnd.kahootz", PermissibleValue(text="vnd.kahootz"))
        setattr(cls, "vnd.kde.karbon", PermissibleValue(text="vnd.kde.karbon"))
        setattr(cls, "vnd.kde.kchart", PermissibleValue(text="vnd.kde.kchart"))
        setattr(cls, "vnd.kde.kformula", PermissibleValue(text="vnd.kde.kformula"))
        setattr(cls, "vnd.kde.kivio", PermissibleValue(text="vnd.kde.kivio"))
        setattr(cls, "vnd.kde.kontour", PermissibleValue(text="vnd.kde.kontour"))
        setattr(cls, "vnd.kde.kpresenter", PermissibleValue(text="vnd.kde.kpresenter"))
        setattr(cls, "vnd.kde.kspread", PermissibleValue(text="vnd.kde.kspread"))
        setattr(cls, "vnd.kde.kword", PermissibleValue(text="vnd.kde.kword"))
        setattr(cls, "vnd.kenameaapp", PermissibleValue(text="vnd.kenameaapp"))
        ...
        setattr(cls, "vnd.laszip", PermissibleValue(text="vnd.laszip"))
        setattr(cls, "vnd.leap+json", PermissibleValue(text="vnd.leap+json"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.mcd", PermissibleValue(text="vnd.mcd"))
        setattr(cls, "vnd.mdl", PermissibleValue(text="vnd.mdl"))
        setattr(cls, "vnd.mdl-mbsdf", PermissibleValue(text="vnd.mdl-mbsdf"))
        setattr(cls, "vnd.medcalcdata", PermissibleValue(text="vnd.medcalcdata"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.mermaid", PermissibleValue(text="vnd.mermaid"))
        setattr(cls, "vnd.MFER", PermissibleValue(text="vnd.MFER"))
        setattr(cls, "vnd.mfmp", PermissibleValue(text="vnd.mfmp"))
        setattr(cls, "vnd.micro+json", PermissibleValue(text="vnd.micro+json"))
        setattr(cls, "vnd.micrografx.flo", PermissibleValue(text="vnd.micrografx.flo"))
        setattr(cls, "vnd.micrografx.igx", PermissibleValue(text="vnd.micrografx.igx"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.miele+json", PermissibleValue(text="vnd.miele+json"))
        setattr(cls, "vnd.mif", PermissibleValue(text="vnd.mif"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.Mobius.DAF", PermissibleValue(text="vnd.Mobius.DAF"))
        setattr(cls, "vnd.Mobius.DIS", PermissibleValue(text="vnd.Mobius.DIS"))
        setattr(cls, "vnd.Mobius.MBK", PermissibleValue(text="vnd.Mobius.MBK"))
        setattr(cls, "vnd.Mobius.MQY", PermissibleValue(text="vnd.Mobius.MQY"))
        setattr(cls, "vnd.Mobius.MSL", PermissibleValue(text="vnd.Mobius.MSL"))
        setattr(cls, "vnd.Mobius.PLC", PermissibleValue(text="vnd.Mobius.PLC"))
        setattr(cls, "vnd.Mobius.TXF", PermissibleValue(text="vnd.Mobius.TXF"))
        setattr(cls, "vnd.modl", PermissibleValue(text="vnd.modl"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.ms-fontobject", PermissibleValue(text="vnd.ms-fontobject"))
        setattr(cls, "vnd.ms-htmlhelp", PermissibleValue(text="vnd.ms-htmlhelp"))
        setattr(cls, "vnd.ms-ims", PermissibleValue(text="vnd.ms-ims"))
        setattr(cls, "vnd.ms-lrm", PermissibleValue(text="vnd.ms-lrm"))
        setattr(
            cls,
            "vnd.ms-office.activeX+xml",
            PermissibleValue(text="vnd.ms-office.activeX+xml"),
        )
        setattr(cls, "vnd.ms-officetheme", PermissibleValue(text="vnd.ms-officetheme"))
        setattr(
            cls,
            "vnd.ms-playready.initiator+xml",
            PermissibleValue(text="vnd.ms-playready.initiator+xml"),
        )
        setattr(cls, "vnd.ms-powerpoint", PermissibleValue(text="vnd.ms-powerpoint"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.ms-project", PermissibleValue(text="vnd.ms-project"))
        setattr(cls, "vnd.ms-tnef", PermissibleValue(text="vnd.ms-tnef"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.ms-works", PermissibleValue(text="vnd.ms-works"))
        setattr(cls, "vnd.ms-wpl", PermissibleValue(text="vnd.ms-wpl"))
        setattr(cls, "vnd.ms-xpsdocument", PermissibleValue(text="vnd.ms-xpsdocument"))
        ...
        setattr(cls, "vnd.musician", PermissibleValue(text="vnd.musician"))
        setattr(cls, "vnd.music-niff", PermissibleValue(text="vnd.music-niff"))
        setattr(cls, "vnd.muvee.style", PermissibleValue(text="vnd.muvee.style"))
        setattr(cls, "vnd.mynfc", PermissibleValue(text="vnd.mynfc"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.nitf", PermissibleValue(text="vnd.nitf"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.nokia.ncd", PermissibleValue(text="vnd.nokia.ncd"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.novadigm.EDM", PermissibleValue(text="vnd.novadigm.EDM"))
        setattr(cls, "vnd.novadigm.EDX", PermissibleValue(text="vnd.novadigm.EDX"))
        setattr(cls, "vnd.novadigm.EXT", PermissibleValue(text="vnd.novadigm.EXT"))
        setattr(
            cls,
        ...
        setattr(
            ...
            PermissibleValue(
                text="vnd.oasis.opendocument.database (OBSOLETED in favor of application/vnd.oasis.opendocument.base)"
            ),
        )
        setattr(
            cls,
        ...
        setattr(cls, "vnd.obn", PermissibleValue(text="vnd.obn"))
        setattr(cls, "vnd.ocf+cbor", PermissibleValue(text="vnd.ocf+cbor"))
        setattr(
            cls,
            "vnd.oci.image.manifest.v1+json",
            PermissibleValue(text="vnd.oci.image.manifest.v1+json"),
        )
        setattr(cls, "vnd.oftn.l10n+json", PermissibleValue(text="vnd.oftn.l10n+json"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.oipf.pae.gem", PermissibleValue(text="vnd.oipf.pae.gem"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.olpc-sugar", PermissibleValue(text="vnd.olpc-sugar"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.oma.bcast.sgdu", PermissibleValue(text="vnd.oma.bcast.sgdu"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.oma.bcast.stkm", PermissibleValue(text="vnd.oma.bcast.stkm"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.oma.lwm2m+cbor", PermissibleValue(text="vnd.oma.lwm2m+cbor"))
        setattr(cls, "vnd.oma.lwm2m+json", PermissibleValue(text="vnd.oma.lwm2m+json"))
        setattr(cls, "vnd.oma.lwm2m+tlv", PermissibleValue(text="vnd.oma.lwm2m+tlv"))
        setattr(cls, "vnd.oma.pal+xml", PermissibleValue(text="vnd.oma.pal+xml"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.oma.push", PermissibleValue(text="vnd.oma.push"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.onepager", PermissibleValue(text="vnd.onepager"))
        setattr(cls, "vnd.onepagertamp", PermissibleValue(text="vnd.onepagertamp"))
        setattr(cls, "vnd.onepagertamx", PermissibleValue(text="vnd.onepagertamx"))
        setattr(cls, "vnd.onepagertat", PermissibleValue(text="vnd.onepagertat"))
        setattr(cls, "vnd.onepagertatp", PermissibleValue(text="vnd.onepagertatp"))
        setattr(cls, "vnd.onepagertatx", PermissibleValue(text="vnd.onepagertatx"))
        setattr(cls, "vnd.onvif.metadata", PermissibleValue(text="vnd.onvif.metadata"))
        setattr(
            cls,
        ...
        setattr(
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.presentationml.commentAuthors+xml"
            ),
        )
        setattr(
            cls,
        ...
        setattr(
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.presentationml.handoutMaster+xml"
            ),
        )
        setattr(
            cls,
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.presentationml.notesMaster+xml"
            ),
        )
        setattr(
            cls,
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.presentationml.notesSlide+xml"
            ),
        )
        setattr(
            cls,
        ...
        setattr(
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.presentationml.presentation.main+xml"
            ),
        )
        setattr(
            cls,
        ...
        setattr(
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.presentationml.slideLayout+xml"
            ),
        )
        setattr(
            cls,
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.presentationml.slideMaster+xml"
            ),
        )
        setattr(
            cls,
        ...
        setattr(
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.presentationml.slideshow.main+xml"
            ),
        )
        setattr(
            cls,
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.presentationml.slideUpdateInfo+xml"
            ),
        )
        setattr(
            cls,
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.presentationml.tableStyles+xml"
            ),
        )
        setattr(
            cls,
        ...
        setattr(
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.presentationml.template.main+xml"
            ),
        )
        setattr(
            cls,
        ...
        setattr(
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.spreadsheetml.connections+xml"
            ),
        )
        setattr(
            cls,
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.spreadsheetml.dialogsheet+xml"
            ),
        )
        setattr(
            cls,
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.spreadsheetml.externalLink+xml"
            ),
        )
        setattr(
            cls,
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.spreadsheetml.pivotCacheDefinition+xml"
            ),
        )
        setattr(
            cls,
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.spreadsheetml.pivotCacheRecords+xml"
            ),
        )
        setattr(
            cls,
        ...
        setattr(
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.spreadsheetml.revisionHeaders+xml"
            ),
        )
        setattr(
            cls,
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.spreadsheetml.revisionLog+xml"
            ),
        )
        setattr(
            cls,
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.spreadsheetml.sharedStrings+xml"
            ),
        )
        setattr(
            cls,
        ...
        setattr(
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.spreadsheetml.sheetMetadata+xml"
            ),
        )
        setattr(
            cls,
        ...
        setattr(
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.spreadsheetml.tableSingleCells+xml"
            ),
        )
        setattr(
            cls,
        ...
        setattr(
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.spreadsheetml.template.main+xml"
            ),
        )
        setattr(
            cls,
        ...
        setattr(
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.spreadsheetml.volatileDependencies+xml"
            ),
        )
        setattr(
            cls,
        ...
        setattr(
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.wordprocessingml.comments+xml"
            ),
        )
        setattr(
            cls,
        ...
        setattr(
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.wordprocessingml.document.glossary+xml"
            ),
        )
        setattr(
            cls,
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.wordprocessingml.document.main+xml"
            ),
        )
        setattr(
            cls,
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.wordprocessingml.endnotes+xml"
            ),
        )
        setattr(
            cls,
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.wordprocessingml.fontTable+xml"
            ),
        )
        setattr(
            cls,
        ...
        setattr(
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.wordprocessingml.footnotes+xml"
            ),
        )
        setattr(
            cls,
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.wordprocessingml.numbering+xml"
            ),
        )
        setattr(
            cls,
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.wordprocessingml.settings+xml"
            ),
        )
        setattr(
            cls,
        ...
        setattr(
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.wordprocessingml.template.main+xml"
            ),
        )
        setattr(
            cls,
            ...
            PermissibleValue(
                text="vnd.openxmlformats-officedocument.wordprocessingml.webSettings+xml"
            ),
        )
        setattr(
            cls,
        ...
        setattr(cls, "vnd.orange.indata", PermissibleValue(text="vnd.orange.indata"))
        setattr(cls, "vnd.osa.netdeploy", PermissibleValue(text="vnd.osa.netdeploy"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.pg.osasli", PermissibleValue(text="vnd.pg.osasli"))
        setattr(
            cls,
            "vnd.piaccess.application-licence",
            PermissibleValue(text="vnd.piaccess.application-licence"),
        )
        setattr(cls, "vnd.picsel", PermissibleValue(text="vnd.picsel"))
        setattr(cls, "vnd.pmi.widget", PermissibleValue(text="vnd.pmi.widget"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.realvnc.bed", PermissibleValue(text="vnd.realvnc.bed"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.sar", PermissibleValue(text="vnd.sar"))
        setattr(cls, "vnd.sbm.cid", PermissibleValue(text="vnd.sbm.cid"))
        setattr(cls, "vnd.sbm.mid2", PermissibleValue(text="vnd.sbm.mid2"))
        setattr(cls, "vnd.scribus", PermissibleValue(text="vnd.scribus"))
        setattr(cls, "vnd.sealed.3df", PermissibleValue(text="vnd.sealed.3df"))
        setattr(cls, "vnd.sealed.csf", PermissibleValue(text="vnd.sealed.csf"))
        setattr(cls, "vnd.sealed.doc", PermissibleValue(text="vnd.sealed.doc"))
        setattr(cls, "vnd.sealed.eml", PermissibleValue(text="vnd.sealed.eml"))
        setattr(cls, "vnd.sealed.mht", PermissibleValue(text="vnd.sealed.mht"))
        setattr(cls, "vnd.sealed.net", PermissibleValue(text="vnd.sealed.net"))
        setattr(cls, "vnd.sealed.ppt", PermissibleValue(text="vnd.sealed.ppt"))
        setattr(cls, "vnd.sealed.tiff", PermissibleValue(text="vnd.sealed.tiff"))
        setattr(cls, "vnd.sealed.xls", PermissibleValue(text="vnd.sealed.xls"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.seemail", PermissibleValue(text="vnd.seemail"))
        setattr(cls, "vnd.seis+json", PermissibleValue(text="vnd.seis+json"))
        ...
        setattr(cls, "vnd.sigrok.session", PermissibleValue(text="vnd.sigrok.session"))
        setattr(
            cls,
            "vnd.SimTech-MindMapper",
            PermissibleValue(text="vnd.SimTech-MindMapper"),
        )
        setattr(cls, "vnd.siren+json", PermissibleValue(text="vnd.siren+json"))
        setattr(cls, "vnd.smaf", PermissibleValue(text="vnd.smaf"))
        setattr(cls, "vnd.smart.notebook", PermissibleValue(text="vnd.smart.notebook"))
        setattr(cls, "vnd.smart.teacher", PermissibleValue(text="vnd.smart.teacher"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.street-stream", PermissibleValue(text="vnd.street-stream"))
        setattr(cls, "vnd.sun.wadl+xml", PermissibleValue(text="vnd.sun.wadl+xml"))
        setattr(cls, "vnd.sus-calendar", PermissibleValue(text="vnd.sus-calendar"))
        setattr(cls, "vnd.svd", PermissibleValue(text="vnd.svd"))
        setattr(cls, "vnd.swiftview-ics", PermissibleValue(text="vnd.swiftview-ics"))
        setattr(cls, "vnd.sybyl.mol2", PermissibleValue(text="vnd.sybyl.mol2"))
        setattr(cls, "vnd.sycle+xml", PermissibleValue(text="vnd.sycle+xml"))
        setattr(cls, "vnd.syft+json", PermissibleValue(text="vnd.syft+json"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.tcpdump.pcap", PermissibleValue(text="vnd.tcpdump.pcap"))
        setattr(
            cls,
            "vnd.think-cell.ppttc+json",
            PermissibleValue(text="vnd.think-cell.ppttc+json"),
        )
        setattr(cls, "vnd.tml", PermissibleValue(text="vnd.tml"))
        setattr(
            cls,
            "vnd.tmd.mediaflex.api+xml",
            PermissibleValue(text="vnd.tmd.mediaflex.api+xml"),
        )
        setattr(cls, "vnd.tmobile-livetv", PermissibleValue(text="vnd.tmobile-livetv"))
        setattr(cls, "vnd.tri.onesource", PermissibleValue(text="vnd.tri.onesource"))
        setattr(cls, "vnd.trid.tpt", PermissibleValue(text="vnd.trid.tpt"))
        ...
        setattr(cls, "vnd.unity", PermissibleValue(text="vnd.unity"))
        setattr(cls, "vnd.uoml+xml", PermissibleValue(text="vnd.uoml+xml"))
        setattr(cls, "vnd.uplanet.alert", PermissibleValue(text="vnd.uplanet.alert"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.uri-map", PermissibleValue(text="vnd.uri-map"))
        setattr(cls, "vnd.uplanet.signal", PermissibleValue(text="vnd.uplanet.signal"))
        setattr(
            cls,
            "vnd.valve.source.material",
            PermissibleValue(text="vnd.valve.source.material"),
        )
        setattr(cls, "vnd.vcx", PermissibleValue(text="vnd.vcx"))
        ...
        setattr(cls, "vnd.veryant.thin", PermissibleValue(text="vnd.veryant.thin"))
        setattr(cls, "vnd.ves.encrypted", PermissibleValue(text="vnd.ves.encrypted"))
        setattr(
            cls,
            "vnd.vidsoft.vidconference",
            PermissibleValue(text="vnd.vidsoft.vidconference"),
        )
        setattr(cls, "vnd.visio", PermissibleValue(text="vnd.visio"))
        setattr(cls, "vnd.visionary", PermissibleValue(text="vnd.visionary"))
        setattr(
            cls,
            "vnd.vividence.scriptfile",
            PermissibleValue(text="vnd.vividence.scriptfile"),
        )
        setattr(cls, "vnd.vsf", PermissibleValue(text="vnd.vsf"))
        setattr(cls, "vnd.wap.sic", PermissibleValue(text="vnd.wap.sic"))
        setattr(cls, "vnd.wap.slc", PermissibleValue(text="vnd.wap.slc"))
        setattr(cls, "vnd.wap.wbxml", PermissibleValue(text="vnd.wap.wbxml"))
        setattr(cls, "vnd.wap.wmlc", PermissibleValue(text="vnd.wap.wmlc"))
        setattr(cls, "vnd.wap.wmlscriptc", PermissibleValue(text="vnd.wap.wmlscriptc"))
        setattr(cls, "vnd.wasmflow.wafl", PermissibleValue(text="vnd.wasmflow.wafl"))
        setattr(cls, "vnd.webturbo", PermissibleValue(text="vnd.webturbo"))
        setattr(cls, "vnd.wfa.dpp", PermissibleValue(text="vnd.wfa.dpp"))
        setattr(cls, "vnd.wfa.p2p", PermissibleValue(text="vnd.wfa.p2p"))
        setattr(cls, "vnd.wfa.wsc", PermissibleValue(text="vnd.wfa.wsc"))
        setattr(
            cls,
            "vnd.windows.devicepairing",
            PermissibleValue(text="vnd.windows.devicepairing"),
        )
        setattr(cls, "vnd.wmc", PermissibleValue(text="vnd.wmc"))
        setattr(cls, "vnd.wmf.bootstrap", PermissibleValue(text="vnd.wmf.bootstrap"))
        setattr(
            cls,
        ...
        setattr(cls, "vnd.wolfram.player", PermissibleValue(text="vnd.wolfram.player"))
        setattr(cls, "vnd.wordlift", PermissibleValue(text="vnd.wordlift"))
        setattr(cls, "vnd.wordperfect", PermissibleValue(text="vnd.wordperfect"))
        setattr(cls, "vnd.wqd", PermissibleValue(text="vnd.wqd"))
        setattr(
            cls,
            "vnd.wrq-hp3000-labelled",
            PermissibleValue(text="vnd.wrq-hp3000-labelled"),
        )
        setattr(cls, "vnd.wt.stf", PermissibleValue(text="vnd.wt.stf"))
        setattr(cls, "vnd.wv.csp+xml", PermissibleValue(text="vnd.wv.csp+xml"))
        setattr(cls, "vnd.wv.csp+wbxml", PermissibleValue(text="vnd.wv.csp+wbxml"))
        setattr(cls, "vnd.wv.ssp+xml", PermissibleValue(text="vnd.wv.ssp+xml"))
        setattr(cls, "vnd.xacml+json", PermissibleValue(text="vnd.xacml+json"))
        setattr(cls, "vnd.xara", PermissibleValue(text="vnd.xara"))
        setattr(cls, "vnd.xfdl", PermissibleValue(text="vnd.xfdl"))
        setattr(cls, "vnd.xfdl.webform", PermissibleValue(text="vnd.xfdl.webform"))
        setattr(cls, "vnd.xmi+xml", PermissibleValue(text="vnd.xmi+xml"))
        setattr(cls, "vnd.xmpie.cpkg", PermissibleValue(text="vnd.xmpie.cpkg"))
        setattr(cls, "vnd.xmpie.dpkg", PermissibleValue(text="vnd.xmpie.dpkg"))
        setattr(cls, "vnd.xmpie.plan", PermissibleValue(text="vnd.xmpie.plan"))
        ...
        setattr(cls, "vnd.yaoweme", PermissibleValue(text="vnd.yaoweme"))
        setattr(
            cls,
        ...
        setattr(cls, "voicexml+xml", PermissibleValue(text="voicexml+xml"))
        ...
        setattr(cls, "xcap-caps+xml", PermissibleValue(text="xcap-caps+xml"))
        setattr(cls, "xcap-diff+xml", PermissibleValue(text="xcap-diff+xml"))
        setattr(cls, "xcap-el+xml", PermissibleValue(text="xcap-el+xml"))
        setattr(cls, "xcap-error+xml", PermissibleValue(text="xcap-error+xml"))
        setattr(cls, "xcap-ns+xml", PermissibleValue(text="xcap-ns+xml"))
        setattr(
            cls,
        ...
        setattr(cls, "xenc+xml", PermissibleValue(text="xenc+xml"))
        setattr(cls, "xhtml+xml", PermissibleValue(text="xhtml+xml"))
        setattr(cls, "xliff+xml", PermissibleValue(text="xliff+xml"))
        setattr(cls, "xml-dtd", PermissibleValue(text="xml-dtd"))
        setattr(cls, "xml-patch+xml", PermissibleValue(text="xml-patch+xml"))
        setattr(cls, "xmpp+xml", PermissibleValue(text="xmpp+xml"))
        setattr(cls, "xop+xml", PermissibleValue(text="xop+xml"))
        setattr(cls, "xslt+xml", PermissibleValue(text="xslt+xml"))
        setattr(cls, "xv+xml", PermissibleValue(text="xv+xml"))
        setattr(cls, "yang-data+cbor", PermissibleValue(text="yang-data+cbor"))
        setattr(cls, "yang-data+json", PermissibleValue(text="yang-data+json"))
        setattr(cls, "yang-data+xml", PermissibleValue(text="yang-data+xml"))
        setattr(cls, "yang-patch+json", PermissibleValue(text="yang-patch+json"))
        setattr(cls, "yang-patch+xml", PermissibleValue(text="yang-patch+xml"))
        setattr(cls, "yin+xml", PermissibleValue(text="yin+xml"))
...
class TenantSeparation(EnumDefinitionImpl):
    ...
    def _addvals(cls):
        setattr(
            cls,
            "hw-virtualized",
            PermissibleValue(text="hw-virtualized", description="TBD"),
        )
        setattr(
            cls,
            "sw-virtualized",
            PermissibleValue(text="sw-virtualized", description="TBD"),
        )
        setattr(
            cls,
            "os-virtualized",
            PermissibleValue(text="os-virtualized", description="TBD"),
        )
        setattr(
            cls,
            "os-hw-virtualized",
            PermissibleValue(text="os-hw-virtualized", description="TBD"),
        )
        setattr(
            cls,
            "hw-partitioned",
            PermissibleValue(text="hw-partitioned", description="TBD"),
        )
...
class ContainerFormat(EnumDefinitionImpl):
    ...
    dockerv1 = PermissibleValue(
        text="dockerv1", description="Container is packaged with Docker v1 format."
    )
...
class ConsistencyType(EnumDefinitionImpl):
    ...
    Other = PermissibleValue(text="Other", description="Unspecified consistency model.")
...
class FileAccessProtocol(EnumDefinitionImpl):
    NFSv3 = PermissibleValue(text="NFSv3", description="NFS Version 3")
    NFSv4 = PermissibleValue(text="NFSv4", description="NFS Version 4")
    CIFS = PermissibleValue(text="CIFS", description="Common Internet File System")
    AFS = PermissibleValue(text="AFS", description="Andrew File System")
    HDFS = PermissibleValue(text="HDFS", description="Hadoop File System")
...
class FileSystemType(EnumDefinitionImpl):
    ...
    ExtFAT = PermissibleValue(text="ExtFAT", description="Extended FAT file system")
    ...
    XFS = PermissibleValue(
        text="XFS", description="XFS file system, cf https://en.wikipedia.org/wiki/XFS"
    )
...
class BlockStorageTechnology(EnumDefinitionImpl):
    HDD = PermissibleValue(text="HDD", description="Regular magnetic Hard Drive Disk")
    SSD = PermissibleValue(text="SSD", description="Solid State Drive")
    Optane = PermissibleValue(text="Optane", description="Intel Optane Drive")
...
class BlockAccessProtocol(EnumDefinitionImpl):
    ...
    SAS = PermissibleValue(
        text="SAS", description="Directly attached local storage using SAS interface"
    )
    SATA = PermissibleValue(
        text="SATA", description="Directly attached local storage using SATA interface"
    )
    NVME = PermissibleValue(
        text="NVME", description="Directly attached local storage using NVME interface"
    )
    Other = PermissibleValue(text="Other", description="Unspecified protocol")
...
class StorageAPI(EnumDefinitionImpl):
    Swift = PermissibleValue(text="Swift", description="OpenStack Swift API")
    ...
    def _addvals(cls):
        setattr(
            cls,
            "Azure-Blob",
            PermissibleValue(text="Azure-Blob", description="Azure Blob API"),
        )
...
class WatchDogActions(EnumDefinitionImpl):
    ...
    reset = PermissibleValue(
        text="reset", description="Restart of guest us forced if server hangs."
    )
...
slots.address__countryCode = Slot(
    uri=GX.countryCode,
    name="address__countryCode",
    curie=GX.curie("countryCode"),
    model_uri=GX.address__countryCode,
    domain=None,
    range=str,
)

slots.address__gps = Slot(
    uri=GX.gps,
    name="address__gps",
    curie=GX.curie("gps"),
    model_uri=GX.address__gps,
    domain=None,
    range=Optional[Union[Union[dict, GPSLocation], List[Union[dict, GPSLocation]]]],
)

slots.address__streetAddress = Slot(
    uri=VCARD["street-address"],
    name="address__streetAddress",
    curie=VCARD.curie("street-address"),
    model_uri=GX.address__streetAddress,
    domain=None,
    range=Optional[str],
)

slots.address__postalCode = Slot(
    uri=VCARD["postal-code"],
    name="address__postalCode",
    curie=VCARD.curie("postal-code"),
    model_uri=GX.address__postalCode,
    domain=None,
    range=Optional[str],
)

slots.address__locality = Slot(
    uri=VCARD.locality,
    name="address__locality",
    curie=VCARD.curie("locality"),
    model_uri=GX.address__locality,
    domain=None,
    range=Optional[str],
)

slots.gPSLocation__latitude = Slot(
    uri=GX.latitude,
    name="gPSLocation__latitude",
    curie=GX.curie("latitude"),
    model_uri=GX.gPSLocation__latitude,
    domain=None,
    range=str,
)

slots.gPSLocation__longitude = Slot(
    uri=GX.longitude,
    name="gPSLocation__longitude",
    curie=GX.curie("longitude"),
    model_uri=GX.gPSLocation__longitude,
    domain=None,
    range=str,
)

slots.gPSLocation__altitude = Slot(
    uri=GX.altitude,
    name="gPSLocation__altitude",
    curie=GX.curie("altitude"),
    model_uri=GX.gPSLocation__altitude,
    domain=None,
    range=Optional[str],
)

slots.gPSLocation__crs = Slot(
    uri=GX.crs,
    name="gPSLocation__crs",
    curie=GX.curie("crs"),
    model_uri=GX.gPSLocation__crs,
    domain=None,
    range=Optional[str],
    pattern=re.compile(r"^CRS"),
)

slots.gPSUnit__degrees = Slot(
    uri=GX.degrees,
    name="gPSUnit__degrees",
    curie=GX.curie("degrees"),
    model_uri=GX.gPSUnit__degrees,
    domain=None,
    range=int,
)

slots.gPSUnit__minutes = Slot(
    uri=GX.minutes,
    name="gPSUnit__minutes",
    curie=GX.curie("minutes"),
    model_uri=GX.gPSUnit__minutes,
    domain=None,
    range=Optional[int],
)

slots.gPSUnit__seconds = Slot(
    uri=GX.seconds,
    name="gPSUnit__seconds",
    curie=GX.curie("seconds"),
    model_uri=GX.gPSUnit__seconds,
    domain=None,
    range=Optional[int],
)

slots.gPSUnit__decimals = Slot(
    uri=GX.decimals,
    name="gPSUnit__decimals",
    curie=GX.curie("decimals"),
    model_uri=GX.gPSUnit__decimals,
    domain=None,
    range=Optional[float],
)

slots.gaiaXEntity__name = Slot(
    uri=GX.name,
    name="gaiaXEntity__name",
    curie=GX.curie("name"),
    model_uri=GX.gaiaXEntity__name,
    domain=None,
    range=Optional[str],
)

slots.gaiaXEntity__description = Slot(
    uri=GX.description,
    name="gaiaXEntity__description",
    curie=GX.curie("description"),
    model_uri=GX.gaiaXEntity__description,
    domain=None,
    range=Optional[str],
)

slots.cPU__cpuArchitecture = Slot(
    uri=GX.cpuArchitecture,
    name="cPU__cpuArchitecture",
    curie=GX.curie("cpuArchitecture"),
    model_uri=GX.cPU__cpuArchitecture,
    domain=None,
    range=Optional[Union[str, "Architectures"]],
)

slots.cPU__cpuFlag = Slot(
    uri=GX.cpuFlag,
    name="cPU__cpuFlag",
    curie=GX.curie("cpuFlag"),
    model_uri=GX.cPU__cpuFlag,
    domain=None,
    range=Optional[Union[str, List[str]]],
)

slots.cPU__smtEnabled = Slot(
    uri=GX.smtEnabled,
    name="cPU__smtEnabled",
    curie=GX.curie("smtEnabled"),
    model_uri=GX.cPU__smtEnabled,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.cPU__numberOfCores = Slot(
    uri=GX.numberOfCores,
    name="cPU__numberOfCores",
    curie=GX.curie("numberOfCores"),
    model_uri=GX.cPU__numberOfCores,
    domain=None,
    range=Optional[int],
)

slots.cPU__numberOfThreads = Slot(
    uri=GX.numberOfThreads,
    name="cPU__numberOfThreads",
    curie=GX.curie("numberOfThreads"),
    model_uri=GX.cPU__numberOfThreads,
    domain=None,
    range=Optional[int],
)

slots.cPU__baseFrequency = Slot(
    uri=GX.baseFrequency,
    name="cPU__baseFrequency",
    curie=GX.curie("baseFrequency"),
    model_uri=GX.cPU__baseFrequency,
    domain=None,
    range=Optional[Union[dict, Frequency]],
)

slots.cPU__boostFrequency = Slot(
    uri=GX.boostFrequency,
    name="cPU__boostFrequency",
...
slots.cPU__lastLevelCacheSize = Slot(
    uri=GX.lastLevelCacheSize,
    name="cPU__lastLevelCacheSize",
    curie=GX.curie("lastLevelCacheSize"),
    model_uri=GX.cPU__lastLevelCacheSize,
    domain=None,
    range=Optional[Union[dict, MemorySize]],
)

slots.cPU__thermalDesignPower = Slot(
    uri=GX.thermalDesignPower,
    name="cPU__thermalDesignPower",
    curie=GX.curie("thermalDesignPower"),
    model_uri=GX.cPU__thermalDesignPower,
    domain=None,
    range=Optional[Union[dict, Power]],
)

slots.encryption__cipher = Slot(
    uri=GX.cipher,
    name="encryption__cipher",
    curie=GX.curie("cipher"),
    model_uri=GX.encryption__cipher,
    domain=None,
    range=Union[str, "EncryptionAlgorithm"],
)

slots.encryption__keyManagement = Slot(
    uri=GX.keyManagement,
    name="encryption__keyManagement",
    curie=GX.curie("keyManagement"),
    model_uri=GX.encryption__keyManagement,
    domain=None,
    range=Union[str, "KeyManagement"],
)

slots.checkSum__checkSumCalculation = Slot(
    uri=GX.checkSumCalculation,
    name="checkSum__checkSumCalculation",
    curie=GX.curie("checkSumCalculation"),
    model_uri=GX.checkSum__checkSumCalculation,
    domain=None,
    range=Union[str, "ChecksumAlgorithm"],
)

slots.checkSum__checkSumValue = Slot(
    uri=GX.checkSumValue,
    name="checkSum__checkSumValue",
    curie=GX.curie("checkSumValue"),
    model_uri=GX.checkSum__checkSumValue,
    domain=None,
    range=str,
)

slots.signature__signatureValue = Slot(
    uri=GX.signatureValue,
    name="signature__signatureValue",
    curie=GX.curie("signatureValue"),
    model_uri=GX.signature__signatureValue,
    domain=None,
    range=str,
)

slots.signature__hashAlgorithm = Slot(
    uri=GX.hashAlgorithm,
    name="signature__hashAlgorithm",
    curie=GX.curie("hashAlgorithm"),
    model_uri=GX.signature__hashAlgorithm,
    domain=None,
    range=Union[str, "ChecksumAlgorithm"],
)

slots.signature__signatureAlgorithm = Slot(
    uri=GX.signatureAlgorithm,
    name="signature__signatureAlgorithm",
    curie=GX.curie("signatureAlgorithm"),
    model_uri=GX.signature__signatureAlgorithm,
    domain=None,
    range=Union[str, "SignatureAlgorithm"],
)

slots.device__vendor = Slot(
    uri=GX.vendor,
    name="device__vendor",
    curie=GX.curie("vendor"),
    model_uri=GX.device__vendor,
    domain=None,
    range=Optional[str],
)

slots.device__generation = Slot(
    uri=GX.generation,
    name="device__generation",
    curie=GX.curie("generation"),
    model_uri=GX.device__generation,
    domain=None,
    range=Optional[str],
)

slots.device__defaultOversubscriptionRatio = Slot(
    uri=GX.defaultOversubscriptionRatio,
    name="device__defaultOversubscriptionRatio",
    curie=GX.curie("defaultOversubscriptionRatio"),
    model_uri=GX.device__defaultOversubscriptionRatio,
    domain=None,
    range=Optional[int],
)

slots.device__supportedOversubscriptionRatio = Slot(
    uri=GX.supportedOversubscriptionRatio,
    name="device__supportedOversubscriptionRatio",
    curie=GX.curie("supportedOversubscriptionRatio"),
    model_uri=GX.device__supportedOversubscriptionRatio,
    domain=None,
    range=Optional[int],
)

slots.disk__diskSize = Slot(
    uri=GX.diskSize,
    name="disk__diskSize",
    curie=GX.curie("diskSize"),
    model_uri=GX.disk__diskSize,
    domain=None,
    range=Union[dict, MemorySize],
)

slots.disk__diskType = Slot(
    uri=GX.diskType,
    name="disk__diskType",
...
slots.endpoint__endpointURL = Slot(
    uri=GX.endpointURL,
    name="endpoint__endpointURL",
    curie=GX.curie("endpointURL"),
    model_uri=GX.endpoint__endpointURL,
    domain=None,
    range=Optional[Union[str, URI]],
)

slots.endpoint__standardConformity = Slot(
    uri=GX.standardConformity,
    name="endpoint__standardConformity",
    curie=GX.curie("standardConformity"),
    model_uri=GX.endpoint__standardConformity,
    domain=None,
    range=Union[Union[dict, StandardConformity], List[Union[dict, StandardConformity]]],
)

slots.endpoint__formalDescription = Slot(
    uri=GX.formalDescription,
    name="endpoint__formalDescription",
    curie=GX.curie("formalDescription"),
    model_uri=GX.endpoint__formalDescription,
    domain=None,
    range=Optional[str],
)

slots.gPU__gpuMemory = Slot(
    uri=GX.gpuMemory,
    name="gPU__gpuMemory",
    curie=GX.curie("gpuMemory"),
    model_uri=GX.gPU__gpuMemory,
    domain=None,
    range=Optional[Union[dict, MemorySize]],
)

slots.gPU__gpuInterconnection = Slot(
    uri=GX.gpuInterconnection,
    name="gPU__gpuInterconnection",
    curie=GX.curie("gpuInterconnection"),
    model_uri=GX.gPU__gpuInterconnection,
    domain=None,
    range=Optional[Union[str, "GPUInterconnetionTypes"]],
)

slots.gPU__gpuProcessingUnits = Slot(
    uri=GX.gpuProcessingUnits,
    name="gPU__gpuProcessingUnits",
    curie=GX.curie("gpuProcessingUnits"),
    model_uri=GX.gPU__gpuProcessingUnits,
    domain=None,
    range=Optional[int],
)

slots.gPU__gpuPassthrough = Slot(
    uri=GX.gpuPassthrough,
    name="gPU__gpuPassthrough",
    curie=GX.curie("gpuPassthrough"),
    model_uri=GX.gPU__gpuPassthrough,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.image__fileSize = Slot(
    uri=GX.fileSize,
    name="image__fileSize",
    curie=GX.curie("fileSize"),
    model_uri=GX.image__fileSize,
    domain=None,
    range=Optional[Union[dict, MemorySize]],
)

slots.image__operatingSystem = Slot(
    uri=GX.operatingSystem,
    name="image__operatingSystem",
    curie=GX.curie("operatingSystem"),
    model_uri=GX.image__operatingSystem,
    domain=None,
    range=Optional[Union[dict, OperatingSystem]],
)

slots.image__cpuReq = Slot(
    uri=GX.cpuReq,
    name="image__cpuReq",
    curie=GX.curie("cpuReq"),
    model_uri=GX.image__cpuReq,
    domain=None,
    range=Optional[Union[dict, CPU]],
)

slots.image__gpuReq = Slot(
    uri=GX.gpuReq,
    name="image__gpuReq",
    curie=GX.curie("gpuReq"),
    model_uri=GX.image__gpuReq,
    domain=None,
    range=Optional[Union[dict, GPU]],
)

slots.image__ramReq = Slot(
    uri=GX.ramReq,
    name="image__ramReq",
    curie=GX.curie("ramReq"),
    model_uri=GX.image__ramReq,
    domain=None,
    range=Optional[Union[dict, Memory]],
)

slots.image__videoRamSize = Slot(
    uri=GX.videoRamSize,
    name="image__videoRamSize",
    curie=GX.curie("videoRamSize"),
    model_uri=GX.image__videoRamSize,
    domain=None,
    range=Optional[Union[dict, MemorySize]],
)

slots.image__rootDiskReq = Slot(
    uri=GX.rootDiskReq,
    name="image__rootDiskReq",
    curie=GX.curie("rootDiskReq"),
    model_uri=GX.image__rootDiskReq,
    domain=None,
    range=Optional[Union[dict, Disk]],
)

slots.image__encryption = Slot(
    uri=GX.encryption,
    name="image__encryption",
    curie=GX.curie("encryption"),
    model_uri=GX.image__encryption,
    domain=None,
    range=Optional[Union[dict, Encryption]],
)

slots.image__checkSum = Slot(
    uri=GX.checkSum,
    name="image__checkSum",
    curie=GX.curie("checkSum"),
    model_uri=GX.image__checkSum,
    domain=None,
    range=Optional[Union[dict, CheckSum]],
)

slots.image__secureBoot = Slot(
    uri=GX.secureBoot,
    name="image__secureBoot",
    curie=GX.curie("secureBoot"),
    model_uri=GX.image__secureBoot,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.image__vPMU = Slot(
    uri=GX.vPMU,
    name="image__vPMU",
    curie=GX.curie("vPMU"),
    model_uri=GX.image__vPMU,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.image__multiQueues = Slot(
    uri=GX.multiQueues,
    name="image__multiQueues",
    curie=GX.curie("multiQueues"),
    model_uri=GX.image__multiQueues,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.image__updateStrategy = Slot(
    uri=GX.updateStrategy,
    name="image__updateStrategy",
    curie=GX.curie("updateStrategy"),
    model_uri=GX.image__updateStrategy,
    domain=None,
    range=Optional[Union[dict, UpdateStrategy]],
)

slots.image__licenseIncluded = Slot(
    uri=GX.licenseIncluded,
    name="image__licenseIncluded",
    curie=GX.curie("licenseIncluded"),
    model_uri=GX.image__licenseIncluded,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.image__maintenance = Slot(
    uri=GX.maintenance,
    name="image__maintenance",
    curie=GX.curie("maintenance"),
    model_uri=GX.image__maintenance,
    domain=None,
    range=Optional[Union[dict, MaintenanceSubscription]],
)

slots.maintenanceSubscription__subscriptionIncluded = Slot(
    uri=GX.subscriptionIncluded,
    name="maintenanceSubscription__subscriptionIncluded",
    curie=GX.curie("subscriptionIncluded"),
    model_uri=GX.maintenanceSubscription__subscriptionIncluded,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.maintenanceSubscription__subscriptionRequired = Slot(
    uri=GX.subscriptionRequired,
    name="maintenanceSubscription__subscriptionRequired",
    curie=GX.curie("subscriptionRequired"),
    model_uri=GX.maintenanceSubscription__subscriptionRequired,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.maintenanceSubscription__maintainedUntil = Slot(
    uri=GX.maintainedUntil,
    name="maintenanceSubscription__maintainedUntil",
    curie=GX.curie("maintainedUntil"),
    model_uri=GX.maintenanceSubscription__maintainedUntil,
    domain=None,
    range=Optional[Union[str, XSDDate]],
)

slots.updateStrategy__replaceFrequency = Slot(
    uri=GX.replaceFrequency,
    name="updateStrategy__replaceFrequency",
    curie=GX.curie("replaceFrequency"),
    model_uri=GX.updateStrategy__replaceFrequency,
    domain=None,
    range=Optional[Union[str, "UpdateFrequency"]],
)

slots.updateStrategy__hotfixHours = Slot(
    uri=GX.hotfixHours,
    name="updateStrategy__hotfixHours",
    curie=GX.curie("hotfixHours"),
    model_uri=GX.updateStrategy__hotfixHours,
    domain=None,
    range=Optional[int],
)

slots.updateStrategy__oldVersionsValidUntil = Slot(
    uri=GX.oldVersionsValidUntil,
    name="updateStrategy__oldVersionsValidUntil",
    curie=GX.curie("oldVersionsValidUntil"),
    model_uri=GX.updateStrategy__oldVersionsValidUntil,
    domain=None,
    range=Optional[str],
)

slots.updateStrategy__providedUntil = Slot(
    uri=GX.providedUntil,
    name="updateStrategy__providedUntil",
    curie=GX.curie("providedUntil"),
    model_uri=GX.updateStrategy__providedUntil,
    domain=None,
    range=Optional[str],
)

slots.latestN__value = Slot(
    uri=GX.value,
    name="latestN__value",
    curie=GX.curie("value"),
    model_uri=GX.latestN__value,
    domain=None,
    range=Optional[int],
)

slots.issuer__issuerTermsAndConditions = Slot(
    uri=GX.issuerTermsAndConditions,
    name="issuer__issuerTermsAndConditions",
    curie=GX.curie("issuerTermsAndConditions"),
    model_uri=GX.issuer__issuerTermsAndConditions,
    domain=None,
    range=Union[str, "GaiaXTermsAndConditions"],
)

slots.legalPerson__registrationNumber = Slot(
    uri=GX.registrationNumber,
    name="legalPerson__registrationNumber",
    curie=GX.curie("registrationNumber"),
    model_uri=GX.legalPerson__registrationNumber,
    domain=None,
    range=URIRef,
)

slots.legalPerson__legalAddress = Slot(
    uri=GX.legalAddress,
    name="legalPerson__legalAddress",
    curie=GX.curie("legalAddress"),
    model_uri=GX.legalPerson__legalAddress,
    domain=None,
    range=Union[dict, Address],
)

slots.legalPerson__headquartersAddress = Slot(
    uri=GX.headquartersAddress,
    name="legalPerson__headquartersAddress",
    curie=GX.curie("headquartersAddress"),
    model_uri=GX.legalPerson__headquartersAddress,
    domain=None,
    range=Union[dict, Address],
)

slots.legalPerson__parentOrganizationOf = Slot(
    uri=GX.parentOrganizationOf,
    name="legalPerson__parentOrganizationOf",
    curie=GX.curie("parentOrganizationOf"),
    model_uri=GX.legalPerson__parentOrganizationOf,
    domain=None,
    range=Optional[
        Union[
            Union[str, LegalPersonRegistrationNumber],
...
slots.legalPerson__subOrganisationOf = Slot(
    uri=GX.subOrganisationOf,
    name="legalPerson__subOrganisationOf",
    curie=GX.curie("subOrganisationOf"),
    model_uri=GX.legalPerson__subOrganisationOf,
    domain=None,
    range=Optional[
        Union[
            Union[str, LegalPersonRegistrationNumber],
...
slots.localRegistrationNumber__local = Slot(
    uri=GX.local,
    name="localRegistrationNumber__local",
    curie=GX.curie("local"),
    model_uri=GX.localRegistrationNumber__local,
    domain=None,
    range=URIRef,
)

slots.vatID__vatID = Slot(
    uri=GX.vatID,
    name="vatID__vatID",
    curie=GX.curie("vatID"),
    model_uri=GX.vatID__vatID,
    domain=None,
    range=URIRef,
)

slots.leiCode__leiCode = Slot(
    uri=SCHEMA.leiCode,
    name="leiCode__leiCode",
    curie=SCHEMA.curie("leiCode"),
    model_uri=GX.leiCode__leiCode,
    domain=None,
    range=URIRef,
)

slots.eORI__eori = Slot(
    uri=GX.eori,
    name="eORI__eori",
    curie=GX.curie("eori"),
    model_uri=GX.eORI__eori,
    domain=None,
    range=URIRef,
)

slots.eUID__euid = Slot(
    uri=GX.euid,
    name="eUID__euid",
    curie=GX.curie("euid"),
    model_uri=GX.eUID__euid,
    domain=None,
    range=URIRef,
)

slots.memory__memorySize = Slot(
    uri=GX.memorySize,
    name="memory__memorySize",
    curie=GX.curie("memorySize"),
    model_uri=GX.memory__memorySize,
    domain=None,
    range=Union[dict, MemorySize],
)

slots.memory__memoryClass = Slot(
    uri=GX.memoryClass,
    name="memory__memoryClass",
    curie=GX.curie("memoryClass"),
    model_uri=GX.memory__memoryClass,
    domain=None,
    range=Optional[Union[str, "MemoryClasses"]],
)

slots.memory__memoryRank = Slot(
    uri=GX.memoryRank,
    name="memory__memoryRank",
    curie=GX.curie("memoryRank"),
    model_uri=GX.memory__memoryRank,
    domain=None,
    range=Optional[Union[str, "MemoryRanks"]],
)

slots.memory__eccEnabled = Slot(
    uri=GX.eccEnabled,
    name="memory__eccEnabled",
    curie=GX.curie("eccEnabled"),
    model_uri=GX.memory__eccEnabled,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.memory__hardwareEncryption = Slot(
    uri=GX.hardwareEncryption,
    name="memory__hardwareEncryption",
    curie=GX.curie("hardwareEncryption"),
    model_uri=GX.memory__hardwareEncryption,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.floatPercentage__value = Slot(
    uri=GX.value,
    name="floatPercentage__value",
    curie=GX.curie("value"),
    model_uri=GX.floatPercentage__value,
    domain=None,
    range=Optional[float],
)

slots.pXEImage__pxeImageDiskFormat = Slot(
    uri=GX.pxeImageDiskFormat,
    name="pXEImage__pxeImageDiskFormat",
    curie=GX.curie("pxeImageDiskFormat"),
    model_uri=GX.pXEImage__pxeImageDiskFormat,
    domain=None,
    range=Optional[Union[str, "PXEDiskType"]],
)

slots.resource__aggregationOfResources = Slot(
    uri=GX.aggregationOfResources,
    name="resource__aggregationOfResources",
    curie=GX.curie("aggregationOfResources"),
    model_uri=GX.resource__aggregationOfResources,
    domain=None,
    range=Optional[Union[str, List[str]]],
)

slots.virtualResource__copyrightOwnedBy = Slot(
    uri=GX.copyrightOwnedBy,
    name="virtualResource__copyrightOwnedBy",
    curie=GX.curie("copyrightOwnedBy"),
    model_uri=GX.virtualResource__copyrightOwnedBy,
    domain=None,
    range=Union[str, List[str]],
)

slots.virtualResource__license = Slot(
    uri=GX.license,
    name="virtualResource__license",
    curie=GX.curie("license"),
    model_uri=GX.virtualResource__license,
    domain=None,
    range=Union[str, List[str]],
)

slots.virtualResource__resourcePolicy = Slot(
    uri=GX.resourcePolicy,
    name="virtualResource__resourcePolicy",
    curie=GX.curie("resourcePolicy"),
    model_uri=GX.virtualResource__resourcePolicy,
    domain=None,
    range=Union[str, List[str]],
)

slots.physicalResource__maintainedBy = Slot(
    uri=GX.maintainedBy,
    name="physicalResource__maintainedBy",
    curie=GX.curie("maintainedBy"),
    model_uri=GX.physicalResource__maintainedBy,
    domain=None,
    range=Union[
        Union[str, LegalPersonRegistrationNumber],
        List[Union[str, LegalPersonRegistrationNumber]],
...
slots.physicalResource__ownedBy = Slot(
    uri=GX.ownedBy,
    name="physicalResource__ownedBy",
    curie=GX.curie("ownedBy"),
    model_uri=GX.physicalResource__ownedBy,
    domain=None,
    range=Optional[
        Union[
            Union[str, LegalPersonRegistrationNumber],
...
slots.physicalResource__manufacturedBy = Slot(
    uri=GX.manufacturedBy,
    name="physicalResource__manufacturedBy",
    curie=GX.curie("manufacturedBy"),
    model_uri=GX.physicalResource__manufacturedBy,
    domain=None,
    range=Optional[
        Union[
            Union[str, LegalPersonRegistrationNumber],
...
slots.physicalResource__location = Slot(
    uri=GX.location,
    name="physicalResource__location",
    curie=GX.curie("location"),
    model_uri=GX.physicalResource__location,
    domain=None,
    range=Union[Union[dict, Address], List[Union[dict, Address]]],
)

slots.softwareResource__checksum = Slot(
    uri=GX.checksum,
    name="softwareResource__checksum",
    curie=GX.curie("checksum"),
    model_uri=GX.softwareResource__checksum,
    domain=None,
    range=Optional[Union[dict, CheckSum]],
)

slots.softwareResource__signature = Slot(
    uri=GX.signature,
    name="softwareResource__signature",
    curie=GX.curie("signature"),
    model_uri=GX.softwareResource__signature,
    domain=None,
    range=Optional[Union[dict, Signature]],
)

slots.softwareResource__version = Slot(
    uri=GX.version,
    name="softwareResource__version",
    curie=GX.curie("version"),
    model_uri=GX.softwareResource__version,
    domain=None,
    range=Optional[str],
)

slots.softwareResource__patchLevel = Slot(
    uri=GX.patchLevel,
    name="softwareResource__patchLevel",
    curie=GX.curie("patchLevel"),
    model_uri=GX.softwareResource__patchLevel,
    domain=None,
    range=Optional[str],
)

slots.softwareResource__buildDate = Slot(
    uri=GX.buildDate,
    name="softwareResource__buildDate",
    curie=GX.curie("buildDate"),
    model_uri=GX.softwareResource__buildDate,
    domain=None,
    range=Optional[Union[str, XSDDateTime]],
)

slots.operatingSystem__osDistribution = Slot(
    uri=GX.osDistribution,
    name="operatingSystem__osDistribution",
    curie=GX.curie("osDistribution"),
    model_uri=GX.operatingSystem__osDistribution,
    domain=None,
    range=Union[str, "OSDistribution"],
)

slots.hypervisor__hypervisorType = Slot(
    uri=GX.hypervisorType,
    name="hypervisor__hypervisorType",
    curie=GX.curie("hypervisorType"),
    model_uri=GX.hypervisor__hypervisorType,
    domain=None,
    range=Union[str, "HypervisorType"],
)

slots.serviceOffering__providedBy = Slot(
    uri=GX.providedBy,
    name="serviceOffering__providedBy",
    curie=GX.curie("providedBy"),
    model_uri=GX.serviceOffering__providedBy,
    domain=None,
    range=Union[str, LegalPersonRegistrationNumber],
)

slots.serviceOffering__dependsOn = Slot(
    uri=GX.dependsOn,
    name="serviceOffering__dependsOn",
    curie=GX.curie("dependsOn"),
    model_uri=GX.serviceOffering__dependsOn,
    domain=None,
    range=Optional[Union[str, List[str]]],
)

slots.serviceOffering__aggregationOfResources = Slot(
    uri=GX.aggregationOfResources,
    name="serviceOffering__aggregationOfResources",
    curie=GX.curie("aggregationOfResources"),
    model_uri=GX.serviceOffering__aggregationOfResources,
    domain=None,
    range=Optional[Union[str, List[str]]],
)

slots.serviceOffering__serviceOfferingTermsAndConditions = Slot(
    uri=GX.serviceOfferingTermsAndConditions,
    name="serviceOffering__serviceOfferingTermsAndConditions",
    curie=GX.curie("serviceOfferingTermsAndConditions"),
    model_uri=GX.serviceOffering__serviceOfferingTermsAndConditions,
    domain=None,
    range=Union[Union[dict, TermsAndConditions], List[Union[dict, TermsAndConditions]]],
)

slots.serviceOffering__servicePolicy = Slot(
    uri=GX.servicePolicy,
    name="serviceOffering__servicePolicy",
    curie=GX.curie("servicePolicy"),
    model_uri=GX.serviceOffering__servicePolicy,
    domain=None,
    range=Union[str, List[str]],
)

slots.serviceOffering__dataProtectionRegime = Slot(
    uri=GX.dataProtectionRegime,
    name="serviceOffering__dataProtectionRegime",
    curie=GX.curie("dataProtectionRegime"),
    model_uri=GX.serviceOffering__dataProtectionRegime,
    domain=None,
    range=Optional[
        Union[
            Union[str, "PersonalDataProtectionRegime"],
...
slots.serviceOffering__dataAccountExport = Slot(
    uri=GX.dataAccountExport,
    name="serviceOffering__dataAccountExport",
    curie=GX.curie("dataAccountExport"),
    model_uri=GX.serviceOffering__dataAccountExport,
    domain=None,
    range=Union[Union[dict, DataAccountExport], List[Union[dict, DataAccountExport]]],
)

slots.serviceOffering__keyword = Slot(
    uri=GX.keyword,
    name="serviceOffering__keyword",
    curie=GX.curie("keyword"),
    model_uri=GX.serviceOffering__keyword,
    domain=None,
    range=Optional[Union[str, List[str]]],
)

slots.serviceOffering__provisionType = Slot(
    uri=GX.provisionType,
    name="serviceOffering__provisionType",
    curie=GX.curie("provisionType"),
    model_uri=GX.serviceOffering__provisionType,
    domain=None,
    range=Optional[Union[str, "ProvisionTypes"]],
)

slots.serviceOffering__endpoint = Slot(
    uri=GX.endpoint,
    name="serviceOffering__endpoint",
    curie=GX.curie("endpoint"),
    model_uri=GX.serviceOffering__endpoint,
    domain=None,
    range=Optional[Union[dict, Endpoint]],
)

slots.serviceOffering__hostedOn = Slot(
    uri=GX.hostedOn,
    name="serviceOffering__hostedOn",
    curie=GX.curie("hostedOn"),
    model_uri=GX.serviceOffering__hostedOn,
    domain=None,
    range=Optional[Union[str, List[str]]],
)

slots.computeServiceOffering__tenantSeparation = Slot(
    uri=GX.tenantSeparation,
    name="computeServiceOffering__tenantSeparation",
    curie=GX.curie("tenantSeparation"),
    model_uri=GX.computeServiceOffering__tenantSeparation,
    domain=None,
    range=Optional[Union[str, "TenantSeparation"]],
)

slots.virtualMachineServiceOffering__codeArtifact = Slot(
    uri=GX.codeArtifact,
    name="virtualMachineServiceOffering__codeArtifact",
    curie=GX.curie("codeArtifact"),
    model_uri=GX.virtualMachineServiceOffering__codeArtifact,
    domain=None,
    range=Union[Union[dict, VMImage], List[Union[dict, VMImage]]],
)

slots.virtualMachineServiceOffering__instantiationReq = Slot(
    uri=GX.instantiationReq,
    name="virtualMachineServiceOffering__instantiationReq",
    curie=GX.curie("instantiationReq"),
    model_uri=GX.virtualMachineServiceOffering__instantiationReq,
    domain=None,
    range=Union[Union[dict, ServerFlavor], List[Union[dict, ServerFlavor]]],
)

slots.containerServiceOffering__codeArtifact = Slot(
    uri=GX.codeArtifact,
    name="containerServiceOffering__codeArtifact",
    curie=GX.curie("codeArtifact"),
    model_uri=GX.containerServiceOffering__codeArtifact,
    domain=None,
    range=Union[Union[dict, ContainerImage], List[Union[dict, ContainerImage]]],
)

slots.containerServiceOffering__instantiationReq = Slot(
    uri=GX.instantiationReq,
    name="containerServiceOffering__instantiationReq",
    curie=GX.curie("instantiationReq"),
...
slots.bareMetalServiceOffering__codeArtifact = Slot(
    uri=GX.codeArtifact,
    name="bareMetalServiceOffering__codeArtifact",
    curie=GX.curie("codeArtifact"),
    model_uri=GX.bareMetalServiceOffering__codeArtifact,
    domain=None,
    range=Union[Union[dict, PXEImage], List[Union[dict, PXEImage]]],
)

slots.bareMetalServiceOffering__instantiationReq = Slot(
    uri=GX.instantiationReq,
    name="bareMetalServiceOffering__instantiationReq",
    curie=GX.curie("instantiationReq"),
...
slots.termsAndConditions__url = Slot(
    uri=GX.url,
    name="termsAndConditions__url",
    curie=GX.curie("url"),
    model_uri=GX.termsAndConditions__url,
    domain=None,
    range=Union[str, URI],
)

slots.termsAndConditions__hash = Slot(
    uri=GX.hash,
    name="termsAndConditions__hash",
    curie=GX.curie("hash"),
    model_uri=GX.termsAndConditions__hash,
    domain=None,
    range=str,
)

slots.dataAccountExport__requestType = Slot(
    uri=GX.requestType,
    name="dataAccountExport__requestType",
    curie=GX.curie("requestType"),
    model_uri=GX.dataAccountExport__requestType,
    domain=None,
    range=Union[str, "RequestTypes"],
)

slots.dataAccountExport__accessType = Slot(
    uri=GX.accessType,
    name="dataAccountExport__accessType",
    curie=GX.curie("accessType"),
    model_uri=GX.dataAccountExport__accessType,
    domain=None,
    range=Union[str, "AccessTypes"],
)

slots.dataAccountExport__formatType = Slot(
    uri=GX.formatType,
    name="dataAccountExport__formatType",
    curie=GX.curie("formatType"),
    model_uri=GX.dataAccountExport__formatType,
    domain=None,
    range=Union[str, "MIMETypes"],
)

slots.standardConformity__title = Slot(
    uri=GX.title,
    name="standardConformity__title",
    curie=GX.curie("title"),
    model_uri=GX.standardConformity__title,
    domain=None,
    range=str,
)

slots.standardConformity__standardReference = Slot(
    uri=GX.standardReference,
    name="standardConformity__standardReference",
    curie=GX.curie("standardReference"),
    model_uri=GX.standardConformity__standardReference,
    domain=None,
    range=Union[str, URI],
)

slots.standardConformity__publisher = Slot(
    uri=GX.publisher,
    name="standardConformity__publisher",
    curie=GX.curie("publisher"),
    model_uri=GX.standardConformity__publisher,
    domain=None,
    range=Optional[str],
)

slots.dataResource__producedBy = Slot(
    uri=GX.producedBy,
    name="dataResource__producedBy",
    curie=GX.curie("producedBy"),
    model_uri=GX.dataResource__producedBy,
    domain=None,
    range=Union[str, LegalPersonRegistrationNumber],
)

slots.dataResource__exposedThrough = Slot(
    uri=GX.exposedThrough,
    name="dataResource__exposedThrough",
...
slots.dataResource__obsoleteDateTime = Slot(
    uri=GX.obsoleteDateTime,
    name="dataResource__obsoleteDateTime",
    curie=GX.curie("obsoleteDateTime"),
    model_uri=GX.dataResource__obsoleteDateTime,
    domain=None,
    range=Optional[Union[str, XSDDateTime]],
)

slots.dataResource__expirationDateTime = Slot(
    uri=GX.expirationDateTime,
    name="dataResource__expirationDateTime",
    curie=GX.curie("expirationDateTime"),
    model_uri=GX.dataResource__expirationDateTime,
    domain=None,
    range=Optional[Union[str, XSDDateTime]],
)

slots.dataResource__containsPII = Slot(
    uri=GX.containsPII,
    name="dataResource__containsPII",
    curie=GX.curie("containsPII"),
    model_uri=GX.dataResource__containsPII,
    domain=None,
    range=Union[bool, Bool],
)

slots.dataResource__dataController = Slot(
    uri=GX.dataController,
    name="dataResource__dataController",
    curie=GX.curie("dataController"),
    model_uri=GX.dataResource__dataController,
    domain=None,
    range=Optional[Union[Union[dict, Participant], List[Union[dict, Participant]]]],
)

slots.dataResource__consent = Slot(
    uri=GX.consent,
    name="dataResource__consent",
    curie=GX.curie("consent"),
    model_uri=GX.dataResource__consent,
    domain=None,
    range=Optional[Union[Union[dict, Consent], List[Union[dict, Consent]]]],
)

slots.consent__legalBasis = Slot(
    uri=GX.legalBasis,
    name="consent__legalBasis",
    curie=GX.curie("legalBasis"),
    model_uri=GX.consent__legalBasis,
    domain=None,
    range=str,
)

slots.consent__dataProtectionContactPoint = Slot(
    uri=GX.dataProtectionContactPoint,
    name="consent__dataProtectionContactPoint",
    curie=GX.curie("dataProtectionContactPoint"),
    model_uri=GX.consent__dataProtectionContactPoint,
    domain=None,
    range=Union[str, List[str]],
)

slots.consent__purpose = Slot(
    uri=GX.purpose,
    name="consent__purpose",
    curie=GX.curie("purpose"),
    model_uri=GX.consent__purpose,
    domain=None,
    range=Union[str, List[str]],
)

slots.consent__consentWithdrawalContactPoint = Slot(
    uri=GX.consentWithdrawalContactPoint,
    name="consent__consentWithdrawalContactPoint",
    curie=GX.curie("consentWithdrawalContactPoint"),
    model_uri=GX.consent__consentWithdrawalContactPoint,
    domain=None,
    range=Union[str, List[str]],
)
...
slots.datacenter__aggregationOfResources = Slot(
    ...
    curie=GX.curie("aggregationOfResources"),
    model_uri=GX.datacenter__aggregationOfResources,
    domain=None,
    range=Union[Union[dict, AvailabilityZone], List[Union[dict, AvailabilityZone]]],
)

slots.region__aggregationOfResources = Slot(
    uri=GX.aggregationOfResources,
    name="region__aggregationOfResources",
    curie=GX.curie("aggregationOfResources"),
    model_uri=GX.region__aggregationOfResources,
    domain=None,
    range=Union[Union[dict, Datacenter], List[Union[dict, Datacenter]]],
)

slots.containerImage__baseContainerImage = Slot(
    uri=GX.baseContainerImage,
    name="containerImage__baseContainerImage",
    curie=GX.curie("baseContainerImage"),
    model_uri=GX.containerImage__baseContainerImage,
    domain=None,
    range=Union[dict, BaseContainerImage],
)

slots.containerImage__containerFormat = Slot(
    uri=GX.containerFormat,
    name="containerImage__containerFormat",
    curie=GX.curie("containerFormat"),
    model_uri=GX.containerImage__containerFormat,
    domain=None,
    range=Union[str, "ContainerFormat"],
)

slots.baseContainerImage__containerImageTag = Slot(
    uri=GX.containerImageTag,
    name="baseContainerImage__containerImageTag",
    curie=GX.curie("containerImageTag"),
    model_uri=GX.baseContainerImage__containerImageTag,
    domain=None,
    range=Optional[Union[str, List[str]]],
)

slots.baseContainerImage__containerImageLink = Slot(
    uri=GX.containerImageLink,
    name="baseContainerImage__containerImageLink",
    curie=GX.curie("containerImageLink"),
    model_uri=GX.baseContainerImage__containerImageLink,
    domain=None,
    range=Union[str, URI],
)

slots.containerResourceLimits__cpuRequirements = Slot(
    uri=GX.cpuRequirements,
    name="containerResourceLimits__cpuRequirements",
    curie=GX.curie("cpuRequirements"),
    model_uri=GX.containerResourceLimits__cpuRequirements,
    domain=None,
    range=Optional[Union[dict, CPU]],
)

slots.containerResourceLimits__numberOfCoresLimit = Slot(
    uri=GX.numberOfCoresLimit,
    name="containerResourceLimits__numberOfCoresLimit",
    curie=GX.curie("numberOfCoresLimit"),
    model_uri=GX.containerResourceLimits__numberOfCoresLimit,
    domain=None,
    range=Optional[int],
)

slots.containerResourceLimits__memoryRequirements = Slot(
    uri=GX.memoryRequirements,
    name="containerResourceLimits__memoryRequirements",
    curie=GX.curie("memoryRequirements"),
    model_uri=GX.containerResourceLimits__memoryRequirements,
    domain=None,
    range=Optional[Union[dict, Memory]],
)

slots.containerResourceLimits__memoryLimit = Slot(
    uri=GX.memoryLimit,
    name="containerResourceLimits__memoryLimit",
    curie=GX.curie("memoryLimit"),
    model_uri=GX.containerResourceLimits__memoryLimit,
    domain=None,
    range=Optional[Union[dict, MemorySize]],
)

slots.containerResourceLimits__gpuRequirements = Slot(
    uri=GX.gpuRequirements,
    name="containerResourceLimits__gpuRequirements",
    curie=GX.curie("gpuRequirements"),
    model_uri=GX.containerResourceLimits__gpuRequirements,
    domain=None,
    range=Optional[Union[dict, GPU]],
)

slots.containerResourceLimits__gpuLimit = Slot(
    uri=GX.gpuLimit,
    name="containerResourceLimits__gpuLimit",
    curie=GX.curie("gpuLimit"),
    model_uri=GX.containerResourceLimits__gpuLimit,
    domain=None,
    range=Optional[int],
)

slots.containerResourceLimits__confidential = Slot(
    uri=GX.confidential,
    name="containerResourceLimits__confidential",
    curie=GX.curie("confidential"),
    model_uri=GX.containerResourceLimits__confidential,
    domain=None,
    range=Union[bool, Bool],
)

slots.containerResourceLimits__confidentialComputingTechnology = Slot(
    uri=GX.confidentialComputingTechnology,
    ...
    domain=None,
    range=Optional[Union[dict, ConfidentialComputing]],
)

slots.dataProtectionPolicy__protectionFrequency = Slot(
    uri=GX.protectionFrequency,
    name="dataProtectionPolicy__protectionFrequency",
    curie=GX.curie("protectionFrequency"),
    model_uri=GX.dataProtectionPolicy__protectionFrequency,
    domain=None,
    range=Union[str, "ProtectionFrequency"],
)

slots.dataProtectionPolicy__protectionRetention = Slot(
    uri=GX.protectionRetention,
    name="dataProtectionPolicy__protectionRetention",
    curie=GX.curie("protectionRetention"),
    model_uri=GX.dataProtectionPolicy__protectionRetention,
    domain=None,
    range=Union[dict, RetentionDuration],
)

slots.dataProtectionPolicy__protectionMethod = Slot(
    uri=GX.protectionMethod,
    name="dataProtectionPolicy__protectionMethod",
    curie=GX.curie("protectionMethod"),
    model_uri=GX.dataProtectionPolicy__protectionMethod,
    domain=None,
    range=Optional[Union[str, "ProtectionMethod"]],
)

slots.backupPolicy__backupLocation = Slot(
    uri=GX.backupLocation,
    name="backupPolicy__backupLocation",
    curie=GX.curie("backupLocation"),
    model_uri=GX.backupPolicy__backupLocation,
    domain=None,
    range=Union[Union[dict, Resource], List[Union[dict, Resource]]],
)

slots.backupPolicy__backupReplication = Slot(
    uri=GX.backupReplication,
    name="backupPolicy__backupReplication",
...
slots.snapshotPolicy__snapshotReplication = Slot(
    uri=GX.snapshotReplication,
    name="snapshotPolicy__snapshotReplication",
...
slots.replicationPolicy__synchronousReplication = Slot(
    uri=GX.synchronousReplication,
    name="replicationPolicy__synchronousReplication",
    curie=GX.curie("synchronousReplication"),
    model_uri=GX.replicationPolicy__synchronousReplication,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.replicationPolicy__consistencyType = Slot(
    uri=GX.consistencyType,
    name="replicationPolicy__consistencyType",
    curie=GX.curie("consistencyType"),
    model_uri=GX.replicationPolicy__consistencyType,
    domain=None,
    range=Optional[Union[str, "ConsistencyType"]],
)

slots.replicationPolicy__replicaNumber = Slot(
    uri=GX.replicaNumber,
    name="replicationPolicy__replicaNumber",
    curie=GX.curie("replicaNumber"),
    model_uri=GX.replicationPolicy__replicaNumber,
    domain=None,
    range=Optional[Union[int, List[int]]],
)

slots.replicationPolicy__geoReplication = Slot(
    uri=GX.geoReplication,
    name="replicationPolicy__geoReplication",
    curie=GX.curie("geoReplication"),
...
slots.qoSMetric__metric = Slot(
    uri=GX.metric,
    name="qoSMetric__metric",
    curie=GX.curie("metric"),
    model_uri=GX.qoSMetric__metric,
    domain=None,
    range=Union[dict, Quantity],
)

slots.qoSMetric__guaranteed = Slot(
    uri=GX.guaranteed,
    name="qoSMetric__guaranteed",
    curie=GX.curie("guaranteed"),
    model_uri=GX.qoSMetric__guaranteed,
    domain=None,
    range=Optional[Union[dict, FloatPercentage]],
)

slots.storageQoS__storageThroughput = Slot(
    uri=GX.storageThroughput,
    name="storageQoS__storageThroughput",
    curie=GX.curie("storageThroughput"),
    model_uri=GX.storageQoS__storageThroughput,
    domain=None,
    range=Optional[Union[dict, QoSMetric]],
)

slots.storageQoS__storageLatency = Slot(
    uri=GX.storageLatency,
    name="storageQoS__storageLatency",
    curie=GX.curie("storageLatency"),
    model_uri=GX.storageQoS__storageLatency,
    domain=None,
    range=Optional[Union[dict, QoSMetric]],
)

slots.storageQoS__storageIOPS = Slot(
    uri=GX.storageIOPS,
    name="storageQoS__storageIOPS",
    curie=GX.curie("storageIOPS"),
    model_uri=GX.storageQoS__storageIOPS,
    domain=None,
    range=Optional[Union[dict, QoSMetric]],
)

slots.storageQoS__storageAvailability = Slot(
    uri=GX.storageAvailability,
    name="storageQoS__storageAvailability",
    curie=GX.curie("storageAvailability"),
    model_uri=GX.storageQoS__storageAvailability,
    domain=None,
    range=Optional[Union[dict, FloatPercentage]],
)

slots.storageConfiguration__storageCompression = Slot(
    uri=GX.storageCompression,
    name="storageConfiguration__storageCompression",
    curie=GX.curie("storageCompression"),
...
slots.storageConfiguration__storageDeduplication = Slot(
    uri=GX.storageDeduplication,
    name="storageConfiguration__storageDeduplication",
    curie=GX.curie("storageDeduplication"),
...
slots.storageConfiguration__storageEncryption = Slot(
    uri=GX.storageEncryption,
    name="storageConfiguration__storageEncryption",
    curie=GX.curie("storageEncryption"),
    model_uri=GX.storageConfiguration__storageEncryption,
    domain=None,
    range=Union[Union[dict, Encryption], List[Union[dict, Encryption]]],
)

slots.storageConfiguration__storageRedundancyMechanism = Slot(
    uri=GX.storageRedundancyMechanism,
    name="storageConfiguration__storageRedundancyMechanism",
    curie=GX.curie("storageRedundancyMechanism"),
    model_uri=GX.storageConfiguration__storageRedundancyMechanism,
    domain=None,
    range=Optional[
        Union[
            Union[str, "StorageRedundancyMechanism"],
...
slots.storageConfiguration__storageProtection = Slot(
    uri=GX.storageProtection,
    name="storageConfiguration__storageProtection",
    curie=GX.curie("storageProtection"),
...
slots.storageConfiguration__storageQoS = Slot(
    uri=GX.storageQoS,
    name="storageConfiguration__storageQoS",
    curie=GX.curie("storageQoS"),
    model_uri=GX.storageConfiguration__storageQoS,
    domain=None,
    range=Optional[Union[Union[dict, StorageQoS], List[Union[dict, StorageQoS]]]],
)

slots.storageConfiguration__blockSize = Slot(
    uri=GX.blockSize,
    name="storageConfiguration__blockSize",
    curie=GX.curie("blockSize"),
    model_uri=GX.storageConfiguration__blockSize,
    domain=None,
    range=Optional[Union[Union[dict, MemorySize], List[Union[dict, MemorySize]]]],
)

slots.fileStorageConfiguration__fileSystemType = Slot(
    uri=GX.fileSystemType,
    name="fileStorageConfiguration__fileSystemType",
...
slots.fileStorageConfiguration__highLevelAccessProtocol = Slot(
    uri=GX.highLevelAccessProtocol,
    name="fileStorageConfiguration__highLevelAccessProtocol",
...
slots.blockStorageConfiguration__blockStorageTechnology = Slot(
    uri=GX.blockStorageTechnology,
    name="blockStorageConfiguration__blockStorageTechnology",
    curie=GX.curie("blockStorageTechnology"),
    model_uri=GX.blockStorageConfiguration__blockStorageTechnology,
    domain=None,
    range=Optional[
        Union[
            Union[str, "BlockStorageTechnology"],
...
slots.blockStorageConfiguration__lowLevelBlockAccessProtocol = Slot(
    uri=GX.lowLevelBlockAccessProtocol,
    name="blockStorageConfiguration__lowLevelBlockAccessProtocol",
    curie=GX.curie("lowLevelBlockAccessProtocol"),
...
slots.storageServiceOffering__minimumSize = Slot(
    uri=GX.minimumSize,
    name="storageServiceOffering__minimumSize",
    curie=GX.curie("minimumSize"),
    model_uri=GX.storageServiceOffering__minimumSize,
    domain=None,
    range=Optional[Union[dict, MemorySize]],
)

slots.storageServiceOffering__maximumSize = Slot(
    uri=GX.maximumSize,
    name="storageServiceOffering__maximumSize",
    curie=GX.curie("maximumSize"),
    model_uri=GX.storageServiceOffering__maximumSize,
    domain=None,
    range=Optional[Union[dict, MemorySize]],
)

slots.storageServiceOffering__storageConfiguration = Slot(
    uri=GX.storageConfiguration,
    name="storageServiceOffering__storageConfiguration",
    curie=GX.curie("storageConfiguration"),
    model_uri=GX.storageServiceOffering__storageConfiguration,
    domain=None,
    range=Union[dict, StorageConfiguration],
)

slots.storageServiceOffering__lifetimeManagement = Slot(
    uri=GX.lifetimeManagement,
    name="storageServiceOffering__lifetimeManagement",
    curie=GX.curie("lifetimeManagement"),
    model_uri=GX.storageServiceOffering__lifetimeManagement,
    domain=None,
    range=Optional[int],
)

slots.storageServiceOffering__versioning = Slot(
    uri=GX.versioning,
    name="storageServiceOffering__versioning",
    curie=GX.curie("versioning"),
    model_uri=GX.storageServiceOffering__versioning,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.storageServiceOffering__storageConsistency = Slot(
    uri=GX.storageConsistency,
    name="storageServiceOffering__storageConsistency",
    curie=GX.curie("storageConsistency"),
    model_uri=GX.storageServiceOffering__storageConsistency,
    domain=None,
    range=Optional[Union[str, "ConsistencyType"]],
)

slots.storageServiceOffering__dataViews = Slot(
    uri=GX.dataViews,
    name="storageServiceOffering__dataViews",
    curie=GX.curie("dataViews"),
    model_uri=GX.storageServiceOffering__dataViews,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.storageServiceOffering__multipleViews = Slot(
    uri=GX.multipleViews,
    name="storageServiceOffering__multipleViews",
    curie=GX.curie("multipleViews"),
    model_uri=GX.storageServiceOffering__multipleViews,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.fileStorageServiceOffering__storageConfiguration = Slot(
    uri=GX.storageConfiguration,
    name="fileStorageServiceOffering__storageConfiguration",
    curie=GX.curie("storageConfiguration"),
    model_uri=GX.fileStorageServiceOffering__storageConfiguration,
    domain=None,
    range=Union[dict, FileStorageConfiguration],
)

slots.fileStorageServiceOffering__accessSemantics = Slot(
    uri=GX.accessSemantics,
    name="fileStorageServiceOffering__accessSemantics",
    curie=GX.curie("accessSemantics"),
    model_uri=GX.fileStorageServiceOffering__accessSemantics,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.fileStorageServiceOffering__accessAttributes = Slot(
    uri=GX.accessAttributes,
    name="fileStorageServiceOffering__accessAttributes",
...
slots.blockStorageServiceOffering__storageConfiguration = Slot(
    uri=GX.storageConfiguration,
    name="blockStorageServiceOffering__storageConfiguration",
    curie=GX.curie("storageConfiguration"),
    model_uri=GX.blockStorageServiceOffering__storageConfiguration,
    domain=None,
    range=Union[dict, BlockStorageConfiguration],
)

slots.objectStorageServiceOffering__accessAttributes = Slot(
    uri=GX.accessAttributes,
    name="objectStorageServiceOffering__accessAttributes",
    curie=GX.curie("accessAttributes"),
...
slots.objectStorageServiceOffering__maximumObjectSize = Slot(
    uri=GX.maximumObjectSize,
    name="objectStorageServiceOffering__maximumObjectSize",
    curie=GX.curie("maximumObjectSize"),
    model_uri=GX.objectStorageServiceOffering__maximumObjectSize,
    domain=None,
    range=Optional[Union[dict, MemorySize]],
)

slots.objectStorageServiceOffering__objectAPICompatibility = Slot(
    uri=GX.objectAPICompatibility,
    name="objectStorageServiceOffering__objectAPICompatibility",
    curie=GX.curie("objectAPICompatibility"),
    model_uri=GX.objectStorageServiceOffering__objectAPICompatibility,
    domain=None,
    range=Optional[Union[Union[str, "StorageAPI"], List[Union[str, "StorageAPI"]]]],
)

slots.vMImage__vmImageDiskFormat = Slot(
    uri=GX.vmImageDiskFormat,
    name="vMImage__vmImageDiskFormat",
    curie=GX.curie("vmImageDiskFormat"),
    model_uri=GX.vMImage__vmImageDiskFormat,
    domain=None,
    range=Optional[Union[str, "VMDiskType"]],
)

slots.vMImage__hypervisorType = Slot(
    uri=GX.hypervisorType,
    name="vMImage__hypervisorType",
    curie=GX.curie("hypervisorType"),
    model_uri=GX.vMImage__hypervisorType,
    domain=None,
    range=Optional[Union[str, "HypervisorType"]],
)

slots.vMImage__firmwareType = Slot(
    uri=GX.firmwareType,
    name="vMImage__firmwareType",
    curie=GX.curie("firmwareType"),
    model_uri=GX.vMImage__firmwareType,
    domain=None,
    range=Optional[Union[str, "FirmType"]],
)

slots.vMImage__hwRngTypeOfImage = Slot(
    uri=GX.hwRngTypeOfImage,
    name="vMImage__hwRngTypeOfImage",
    curie=GX.curie("hwRngTypeOfImage"),
    model_uri=GX.vMImage__hwRngTypeOfImage,
    domain=None,
    range=Optional[Union[str, "RNGTypes"]],
)

slots.vMImage__watchDogAction = Slot(
    uri=GX.watchDogAction,
    name="vMImage__watchDogAction",
    curie=GX.curie("watchDogAction"),
    model_uri=GX.vMImage__watchDogAction,
    domain=None,
    range=Optional[Union[str, "WatchDogActions"]],
)

slots.serverFlavor__cpu = Slot(
    uri=GX.cpu,
    name="serverFlavor__cpu",
    curie=GX.curie("cpu"),
    model_uri=GX.serverFlavor__cpu,
    domain=None,
    range=Union[dict, CPU],
)

slots.serverFlavor__ram = Slot(
    uri=GX.ram,
    name="serverFlavor__ram",
    curie=GX.curie("ram"),
    model_uri=GX.serverFlavor__ram,
    domain=None,
    range=Union[dict, Memory],
)

slots.serverFlavor__gpu = Slot(
    uri=GX.gpu,
    name="serverFlavor__gpu",
    curie=GX.curie("gpu"),
    model_uri=GX.serverFlavor__gpu,
    domain=None,
    range=Optional[Union[dict, GPU]],
)

slots.serverFlavor__network = Slot(
    uri=GX.network,
    name="serverFlavor__network",
    curie=GX.curie("network"),
    model_uri=GX.serverFlavor__network,
    domain=None,
    range=Optional[str],
)

slots.serverFlavor__bootVolume = Slot(
    uri=GX.bootVolume,
    name="serverFlavor__bootVolume",
    curie=GX.curie("bootVolume"),
    model_uri=GX.serverFlavor__bootVolume,
    domain=None,
    range=Union[dict, Disk],
)

slots.serverFlavor__additionalVolume = Slot(
    uri=GX.additionalVolume,
    name="serverFlavor__additionalVolume",
    curie=GX.curie("additionalVolume"),
    model_uri=GX.serverFlavor__additionalVolume,
    domain=None,
    range=Optional[Union[Union[dict, Disk], List[Union[dict, Disk]]]],
)

slots.serverFlavor__confidentialComputing = Slot(
    uri=GX.confidentialComputing,
    name="serverFlavor__confidentialComputing",
    curie=GX.curie("confidentialComputing"),
    model_uri=GX.serverFlavor__confidentialComputing,
    domain=None,
    range=Optional[Union[dict, ConfidentialComputing]],
)

slots.serverFlavor__hypervisor = Slot(
    uri=GX.hypervisor,
    name="serverFlavor__hypervisor",
...
slots.serverFlavor__hardwareAssistedVirtualization = Slot(
    uri=GX.hardwareAssistedVirtualization,
    name="serverFlavor__hardwareAssistedVirtualization",
...
slots.serverFlavor__hwRngTypeOfFlavor = Slot(
    uri=GX.hwRngTypeOfFlavor,
    name="serverFlavor__hwRngTypeOfFlavor",
    curie=GX.curie("hwRngTypeOfFlavor"),
    model_uri=GX.serverFlavor__hwRngTypeOfFlavor,
    domain=None,
    range=Optional[Union[str, "RNGTypes"]],
)

slots.confidentialComputing__technology = Slot(
    uri=GX.technology,
    name="confidentialComputing__technology",
    curie=GX.curie("technology"),
    model_uri=GX.confidentialComputing__technology,
    domain=None,
    range=str,
)

slots.confidentialComputing__attestationServiceURI = Slot(
    uri=GX.attestationServiceURI,
    name="confidentialComputing__attestationServiceURI",
    curie=GX.curie("attestationServiceURI"),
    model_uri=GX.confidentialComputing__attestationServiceURI,
    domain=None,
    range=Optional[Union[str, URI]],
)
