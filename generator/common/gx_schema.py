...
class StorageQoS(YAMLRoot):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.storageAvailability is not None and not isinstance(self.storageAvailability, FloatPercentage):
...
class StorageConfiguration(InstantiationRequirement):
    ...
    storageQoS: Optional[Union[Union[dict, StorageQoS], List[Union[dict, StorageQoS]]]] = empty_list()
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self.storageQoS = [v if isinstance(v, StorageQoS) else StorageQoS(**as_dict(v)) for v in self.storageQoS]
...
slots.storageQoS__storageThroughput = Slot(uri=GX.storageThroughput, name="storageQoS__storageThroughput", curie=GX.curie('storageThroughput'),
                   model_uri=GX.storageQoS__storageThroughput, domain=None, range=Optional[Union[dict, QoSMetric]])

slots.storageQoS__storageLatency = Slot(uri=GX.storageLatency, name="storageQoS__storageLatency", curie=GX.curie('storageLatency'),
                   model_uri=GX.storageQoS__storageLatency, domain=None, range=Optional[Union[dict, QoSMetric]])

slots.storageQoS__storageIOPS = Slot(uri=GX.storageIOPS, name="storageQoS__storageIOPS", curie=GX.curie('storageIOPS'),
                   model_uri=GX.storageQoS__storageIOPS, domain=None, range=Optional[Union[dict, QoSMetric]])

slots.storageQoS__storageAvailability = Slot(uri=GX.storageAvailability, name="storageQoS__storageAvailability", curie=GX.curie('storageAvailability'),
                   model_uri=GX.storageQoS__storageAvailability, domain=None, range=Optional[Union[dict, FloatPercentage]])
...
slots.storageConfiguration__storageQoS = Slot(uri=GX.storageQoS, name="storageConfiguration__storageQoS", curie=GX.curie('storageQoS'),
                   model_uri=GX.storageConfiguration__storageQoS, domain=None, range=Optional[Union[Union[dict, StorageQoS], List[Union[dict, StorageQoS]]]])
